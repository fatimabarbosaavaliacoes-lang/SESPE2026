...
const TURMA_2026 = [{
  nome: "Carolina Sandy da Silva Gomes de Sena",
  codigo: "CAROLINA-SANDY",
  senha: "Carolina2951"
}, {
  nome: "Larissa Maria Rabelo dos Anjos",
  codigo: "LARISSA-MARIA",
  senha: "Larissa6234"
}, {
  nome: "Ivania Maria dos Santos",
  codigo: "IVANIA-MARIA",
  senha: "Ivania9233"
}, {
  nome: "Camila Eduarda Nascimento Silvestre",
  codigo: "CAMILA-EDUARDA",
  senha: "Camila9385"
}, {
  nome: "Cledivalda Milena Rodrigues de Arruda",
  codigo: "CLEDIVALDA",
  senha: "Cledivalda2681"
}, {
  nome: "Rafaelli Eloisa da Hora",
  codigo: "RAFAELLI",
  senha: "Rafaelli4658"
}, {
  nome: "Dayane Cybelle Araujo de Andrade Silva",
  codigo: "DAYANE-CYBELLE",
  senha: "Dayane7891"
}, {
  nome: "Eduarda Gayosso",
  codigo: "EDUARDA-GAYOSSO",
  senha: "Eduarda9975"
}, {
  nome: "Ana Carolina Cristóvão",
  codigo: "ANA-CAROLINA",
  senha: "Ana9042"
}, {
  nome: "Sandreane Brasil",
  codigo: "SANDREANE",
  senha: "Sandreane8226"
}];
...
const EIXOS = [{
  id: "etica",
  nome: "Bioética e Legislação",
  curto: "Bioética",
  peso: "alto",
  aulas: 5,
  subs: ["Bioética", "Legislação em enfermagem"],
  ebooks: [{
    arq: "Resifriends_Eixo_Etica.pdf",
    titulo: "Ética e Exercício Profissional",
    pag: 15,
  ...
  id: "semio",
  nome: "Semiologia e SAE",
  curto: "Semiologia",
  peso: "alto",
  aulas: 8,
  subs: ["Anamnese", "Diagnóstico e prognóstico", "Exame clínico", "Exames complementares", "Plano de trabalho", "Protocolos de acolhimento", "Sistematização da assistência (SAE)"],
  ebooks: [{
    arq: "Resifriends_Eixo_Fundamentos.pdf",
  ...
  id: "sistemas",
  nome: "Assistência por Sistemas",
  curto: "Sistemas",
  peso: "alto",
  aulas: 10,
  subs: ["Sistema nervoso", "Sistema respiratório", "Sistema cardiovascular", "Sistema urinário", "Sistema digestório", "Sistema músculo-esquelético", "Sistema endócrino"],
  ebooks: [{
    arq: "Resifriends_Eixo_Sistemas.pdf",
    titulo: "Assistência por Sistemas",
    pag: 34,
  ...
  id: "doencas",
  nome: "Doenças e Agravos",
  curto: "Doenças",
  peso: "medio",
  aulas: 8,
  subs: ["Infectoparasitárias", "IST e infecção pelo HIV", "Crônicas não transmissíveis", "Doenças neoplásicas", "Dermatológicas", "Cuidados paliativos", "Nutrição e dietética"],
  ebooks: [{
    arq: "Resifriends_Eixo_Doencas.pdf",
    titulo: "Doenças e Agravos",
    pag: 29,
    desc: "Dengue (6ª ed.), tuberculose e ILTB com o esquema 3HP, hanseníase, sífilis, PEP/PrEP, neoplasias, paliativos e nutrição."
  }]
}, {
  id: "urg",
  nome: "Urgência, Emergência e Trauma",
  curto: "Urgência",
  peso: "alto",
  aulas: 8,
  subs: ["Urgência e emergência", "Atendimento pré-hospitalar", "Politraumatizado", "Transporte do paciente de risco", "Suporte básico de vida"],
  ebooks: [{
    arq: "Resifriends_Eixo_Urgencia.pdf",
    titulo: "Urgência, Emergência e UTI",
    pag: 19,
    desc: "PCR e RCP pela AHA 2025, ritmos, drogas, Manchester e choque. Inclui o novo algoritmo do engasgo (OVACE)."
  }, {
    arq: "Resifriends_Eixo_Trauma.pdf",
    titulo: "Pré-Hospitalar, Trauma e Transporte",
    pag: 21,
  ...
  id: "seg",
  nome: "Segurança do Paciente e Biossegurança",
  curto: "Segurança",
  peso: "alto",
  aulas: 8,
  subs: ["Segurança do paciente", "Assepsia e antissepsia", "Biossegurança", "Controle de infecção hospitalar", "Limpeza, desinfecção e esterilização", "Programa Nacional de Imunização"],
  ebooks: [{
    arq: "Resifriends_Eixo_Seguranca.pdf",
    ...
    arq: "Resifriends_Eixo_Imunizacao.pdf",
    titulo: "Imunização e PNI",
    pag: 15,
    ...
    arq: "Resifriends_Eixo_Perioperatoria.pdf",
    titulo: "Assistência Perioperatória",
    pag: 24,
  ...
  id: "ciclos",
  nome: "Ciclos de Vida",
  curto: "Ciclos de Vida",
  peso: "alto",
  aulas: 10,
  subs: ["Saúde da criança", "Saúde do adolescente", "Saúde do adulto", "Saúde da mulher", "Saúde do idoso", "Aleitamento materno", "Pré-natal", "Planejamento familiar", "Aborto legal"],
  ebooks: [{
    arq: "Resifriends_Eixo_Ciclos.pdf",
  ...
  peso: "medio",
  aulas: 6,
  subs: ["Teorias da administração", "Liderança e trabalho em equipe", "Gestão de pessoas e escalas", "Dimensionamento de pessoal", "Avaliação de desempenho", "Gestão da qualidade e indicadores", "Organização dos serviços de enfermagem"],
  ebooks: [{
    arq: "Resifriends_Eixo_Administracao.pdf",
    titulo: "Administração em Enfermagem",
    pag: 22,
  ...
  id: "mental",
  nome: "Saúde Mental e Populações Específicas",
  curto: "Saúde Mental",
  peso: "medio",
  aulas: 6,
  subs: ["Saúde mental", "Pessoa com deficiência", "Situação de risco e violência", "Assistência domiciliar"],
  ebooks: [{
    arq: "Resifriends_Eixo_SaudeMental.pdf",
    titulo: "Saúde Mental e Populações Específicas",
    pag: 21,
    desc: "Lei 10.216, RAPS e CAPS, LBI, notificação de violência (Lei 13.931/2019) e atenção domiciliar."
  }]
}, {
  id: "bonus",
  nome: "Epidemiologia e Educação em Saúde",
  curto: "★ Bônus",
  peso: "bonus",
  aulas: 0,
  bonus: true,
  subs: ["Noções de epidemiologia", "Indicadores de saúde coletiva", "Educação em saúde"],
  ebooks: [{
    arq: "Resifriends_Bonus_Epidemiologia.pdf",
    titulo: "Bônus · Epidemiologia e Educação em Saúde",
    pag: 19,
...
// ─────────── SAÚDE MENTAL ───────────
{
  ...
  roteiro: ["Identificar a modalidade: INVOLUNTÁRIA (sem consentimento do paciente, a pedido de terceiro).", "Diferenciar das outras duas: voluntária (consentimento do próprio) e compulsória (ordem judicial).", "Apontar a providência: comunicação ao MINISTÉRIO PÚBLICO em até 72 HORAS — e também na alta.", "Explicar o racional histórico: salvaguarda contra internação como instrumento de exclusão social.", "Mencionar que a internação é o ÚLTIMO recurso (quando os meios extra-hospitalares se mostrarem insuficientes)."],
...
// ─────────── URGÊNCIA ───────────
{
  ...
  roteiro: ["Identificar que a Vítima 1 tem hemorragia exsanguinante externa — o 'X' precede o 'A'.", "Reconhecer que a Vítima 1 tem via aérea pérvia (fala frases completas = A garantido no momento).", "Explicar o racional: a ordem segue a VELOCIDADE com que cada problema mata.", "Justificar: hemorragia exsanguinante mata em segundos; obstrução de via aérea, em minutos.", "Mencionar a unificação com o PHTLS (que já usava XABCDE).", "Diferenciar: X é hemorragia EXTERNA COMPRESSÍVEL; interna permanece no C."],
...
// ─────────── DOENÇAS E AGRAVOS ───────────
{
  ...
  roteiro: ["Identificar a RIFAMPICINA como causa da coloração alaranjada.", "Esclarecer que é efeito ESPERADO e INOFENSIVO — atinge urina, suor e lágrimas.", "Conduta: orientar, acolher o medo, reforçar a adesão e RETOMAR o esquema.", "NÃO suspender: não há nefrotoxicidade nem reação adversa maior.", "Explicar a cadeia: abandono → seleção de bacilos resistentes → TB multirresistente.", "Mencionar o TDO como estratégia de adesão."],
...
// ─────────── SEGURANÇA DO PACIENTE ───────────
{
  ...
  roteiro: ["Identificar a Meta 1 — Identificar corretamente o paciente.", "Apontar os dois erros: uso do leito como identificador e uso de apenas um identificador válido (nome incompleto).", "Explicar que o leito é atributo do LUGAR, não da pessoa.", "Apontar que se exigem DOIS identificadores: nome COMPLETO e data de nascimento.", "Discutir a pergunta indutiva (fechada) vs. a pergunta aberta.", "Mencionar que a checagem deve ser ativa e conferida contra a prescrição/pulseira."],
...
// ─────────── SISTEMAS ───────────
{
  ...
  roteiro: ["Diagnóstico: cetoacidose diabética (CAD).", "Explicar a respiração de KUSSMAUL como compensação respiratória da acidose metabólica.", "Explicar a cascata: falta de insulina → lipólise → corpos cetônicos → acidose.", "Desfazer o erro: a insulina basal é necessária mesmo em jejum (o fígado produz glicose).", "Prioridade: HIDRATAÇÃO (reposição volêmica) antes da insulina.", "Alertar para o POTÁSSIO — a insulina joga K+ para dentro da célula."],
...
// ─────────── BIOÉTICA ───────────
{
  ...
  roteiro: ["Identificar que a conduta é INCORRETA.", "Fundamentar: a execução da sondagem vesical é PRIVATIVA do enfermeiro (Res. COFEN 450/2013, alterada pela 0680/2021).", "Apontar o art. 11 da Lei 7.498/86: cuidados de maior complexidade + decisão imediata + paciente grave.", "Explicar o critério unificador das privativas.", "Discutir que resultado não valida conduta — a responsabilidade é do ato, não do desfecho.", "Mencionar que experiência não transfere competência legal."],
...
// ─────────── SAÚDE MENTAL E POPULAÇÕES ESPECÍFICAS ───────────
{
  ...
  alts: ["O estímulo à autonomia e à co-responsabilidade.", "A articulação e a integração dos diferentes pontos de atenção.", "O fortalecimento das ações de educação permanente nos serviços de saúde.", "A tradução, a divulgação e a comunicação das informações em saúde.", "A promoção da saúde, a qualidade de vida e a prevenção de agravos."],
  correta: 1,
...
// ─────────── SEGURANÇA DO PACIENTE ───────────
{
  ...
  alts: ["ausência de risco de queda, pois a deambulação é mantida com mínima assistência.", "risco leve de queda, sem necessidade de medidas específicas de precaução ambiental.", "risco baixo de queda, exigindo apenas observação periódica e registro diário de Enfermagem.", "risco moderado de queda, devendo ser reavaliado semanalmente pela equipe de Enfermagem.", "risco alto de queda, necessitando implementação imediata de medidas preventivas intensivas."],
  correta: 4,
...
// ─────────── DOENÇAS E AGRAVOS ───────────
{
  ...
  alts: ["o exame clínico é restrito aos contatos que apresentem lesões aparentes ou diminuição da sensibilidade, sendo dispensável para os assintomáticos.", "recomenda-se aplicar a vacina BCG apenas nas crianças menores de 5 anos, independentemente do histórico vacinal anterior, e monitorar os demais.", "o acompanhamento dos contatos deve ocorrer apenas após o término do tratamento do caso índice, para evitar resultados falso-positivos.", "a vacina BCG deve ser administrada a todos os contatos, inclusive os que já receberam duas doses documentadas anteriormente.", "recomenda-se ofertar imunoprofilaxia aos contatos maiores de um ano de idade, não vacinados ou que receberam apenas uma dose da vacina BCG."],
  correta: 4,
...
// ─────────── ADMINISTRAÇÃO EM ENFERMAGEM ───────────
{
  ...
  alts: ["o planejamento estratégico é essencialmente prescritivo, voltado à definição de normas e padrões de conduta.", "o planejamento normativo busca traduzir metas políticas em planos operacionais flexíveis, priorizando a adaptação ao ambiente externo.", "o planejamento estratégico orienta a organização para o futuro com base em diagnósticos e cenários.", "tanto o planejamento estratégico quanto o normativo são prospectivos e dinâmicos, com caráter estritamente técnico.", "o planejamento normativo e o estratégico são equivalentes, pois ambos se concentram na execução operacional e no controle dos resultados organizacionais."],
  correta: 2,
  ...
  id: "fgv25-46",
  eixo: "admin",
  sub: "Organização dos serviços de enfermagem",
  banca: "FGV",
  ano: 2025,
  orgao: "ALE-AM",
  nivel: "media",
  ...
  alts: ["destina-se a internações que durem até 24 horas, voltadas à reabilitação intensiva de pacientes com doenças crônicas.", "oferece cuidados intermediários entre a internação integral e o atendimento ambulatorial, com permanência máxima de 12 horas diárias.", "é voltado para a pacientes psiquiátricos, funcionando como substitutivo das internações hospitalares prolongadas.", "é voltado para procedimentos cirúrgicos de média complexidade, com necessidade de acompanhamento multiprofissional contínuo.", "é um serviço de pronto atendimento destinado a casos de urgência e emergência que não demandam internação prolongada."],
  correta: 1,
...
// ─────────── DOENÇAS E AGRAVOS ───────────
{
  ...
  alts: ["costuma evoluir de forma benigna, mas pode apresentar formas graves em adultos e indivíduos com comorbidades.", "é transmitida por contato sexual desprotegido, apresentando alta taxa de cronicidade.", "é mais grave em adultos, podendo ocasionar sintomas intensos, como icterícia, fadiga e mal-estar geral.", "é uma infecção viral de transmissão fecal-oral, geralmente autolimitada e prevenível por meio de vacinação.", "a infecção ocorre principalmente por transfusão de sangue contaminado e pelo consumo de alimentos contaminados."],
  correta: 3,
...
// ─────────── CICLOS DE VIDA ───────────
{
  ...
  alts: ["a dose diária não deve ultrapassar 200 µg de ácido fólico, devendo ser suspensa após o parto.", "a suplementação deve ser mantida por até 2 meses após o parto, apenas para mulheres que tiveram parto normal.", "a dose diária no pós-parto deve ser de 60 a 100 mg de ferro elementar + 400 µg de ácido fólico.", "a suplementação deve ser iniciada a partir da 30ª semana de gestação, independentemente do estado nutricional.", "a dose diária deve ser de 100 a 200 mg de ferro elementar durante toda a gestação."],
  correta: 2,
...
// ─────────── SEGURANÇA / PNI ───────────
{
  id: "fgv25-51",
  eixo: "seg",
  sub: "Programa Nacional de Imunização",
  banca: "FGV",
  ano: 2025,
  orgao: "ALE-AM",
  nivel: "media",
  ...
  alts: ["tríplice bacteriana - DTP (2º reforço), febre amarela (reforço) e varicela (2ª dose).", "tríplice viral (1ª dose), meningocócica C (reforço) e hepatite B (3ª dose).", "pneumocócica 10-valente (reforço), rotavírus (2ª dose) e influenza sazonal.", "hepatite A (1ª dose), influenza (reforço) e HPV quadrivalente (1ª dose).", "febre amarela (1ª dose), tríplice viral (2ª dose) e varicela (1ª dose)."],
  correta: 0,
  ...
  alts: ["a estrutura da CIPE é organizada por sistemas corporais e patologias, similar ao modelo da Classificação Internacional de Doenças (CID).", "os eixos da CIPE se restringem à descrição de doenças e agravos clínicos, sem incluir fatores relacionados ao ambiente e ao cliente.", "a CIPE utiliza eixos voltados apenas para registro de procedimentos técnicos e aspectos operacionais do cuidado de Enfermagem.", "os eixos da CIPE correspondem às dimensões do processo administrativo de Enfermagem: planejamento, execução e avaliação.", "os eixos da CIPE incluem foco, julgamento, ação, cliente, localização, tempo e meio, compondo a base combinatória para expressar fenômenos e ações de Enfermagem."],
  correta: 4,
...
// ─────────── SAÚDE MENTAL ───────────
{
  ...
  alts: ["transtorno dissociativo, caracterizado por perda temporária da identidade e lacunas de memória episódica.", "transtorno de pânico, caracterizado por episódios agudos de medo intenso e sintomas físicos transitórios.", "transtorno afetivo bipolar, caracterizado por alternância entre fases de euforia e períodos de humor deprimido.", "transtorno obsessivo-compulsivo, caracterizado por pensamentos intrusivos e comportamentos repetitivos de verificação.", "esquizofrenia, caracterizada por delírios, alucinações, discurso desorganizado e prejuízo funcional persistente."],
  correta: 4,
...
// ─────────── DOENÇAS E AGRAVOS ───────────
{
  ...
  alts: ["massagear vigorosamente o local do extravasamento, para dispersar o quimioterápico e acelerar absorção pelos tecidos.", "reduzir a velocidade da infusão, aplicar compressa fria e continuar a administração do quimioterápico até o término.", "suspender o tratamento e encaminhar a paciente para observação, mantendo o acesso venoso com soro fisiológico.", "interromper imediatamente a infusão, aspirar o extravasado, e aplicar compressa morna.", "retirar imediatamente o acesso venoso sem aspirar o extravasado e manter o membro elevado."],
  correta: 3,
  ...
  alts: ["classifica seis níveis de sedação (1 a 6), em que 1 é alerta e 6 sem resposta.", "classifica seis níveis de sedação (0 a 5), sendo 0 o mais leve e 5 o mais profundo.", "classifica a intensidade da dor, sendo utilizada para avaliação analgésica em pacientes críticos.", "inclui avaliação do tamanho pupilar e da reatividade fotomotora, somando pontos ao escore total.", "considera que escore mais alto corresponde à maior vigilância e melhor resposta verbal do paciente."],
  correta: 0,
...
// ─────────── CICLOS DE VIDA ───────────
{
  ...
  alts: ["a realização de manobras uterinas, como a pressão de fundo (manobra de Kristeller), é indicada rotineiramente para acelerar a saída do feto e prevenir hemorragias.", "a episiotomia rotineira é recomendada para todas as parturientes como medida preventiva de lacerações perineais.", "a ocitocina deve ser administrada na parturiente logo após o nascimento do bebê, por via intramuscular, para favorecer a contração uterina e reduzir o risco de hemorragia pós-parto.", "entre as técnicas recomendadas para prevenir a demora no trabalho de parto estão a amniotomia precoce e o uso de agentes antiespasmódicos.", "tricotomia e enema, antes do trabalho de parto são práticas recomendadas de rotina para reduzir infecções e facilitar o nascimento."],
  correta: 2,
  ...
  alts: ["o clampeamento imediato do cordão umbilical é recomendado para prevenir icterícia neonatal e melhorar a oxigenação cerebral do recém-nascido.", "a aspiração das vias aéreas do recém-nascido deve ser realizada de forma rotineira, mesmo sem sinais de obstrução, para prevenir broncoaspiração.", "o banho do recém-nascido deve ser realizado logo após o parto, com o objetivo de remover vérnix caseoso e prevenir infecções cutâneas.", "a administração de vitamina K é indicada apenas para prematuros com baixo peso, sendo desnecessária em recém-nascidos a termo e saudáveis.", "a profilaxia da oftalmia neonatal deve ser realizada rotineiramente com pomada de eritromicina a 0,5% e, como alternativa, tetraciclina a 1%."],
  correta: 4,
...
// ─────────── SEMIOLOGIA / MEDICAÇÃO ───────────
{
  ...
  alts: ["reação anafilática causada por hipersensibilidade medicamentosa.", "crise colinérgica decorrente da estimulação parassimpática excessiva.", "efeito extrapiramidal induzido por antagonismo dopaminérgico central.", "reação serotoninérgica relacionada ao excesso de neurotransmissores.", "síndrome neuroléptica maligna provocada por disfunção autonômica grave."],
  correta: 2,
...
// ─────────── TRAUMA ───────────
{
  ...
  alts: ["hematoma epidural.", "hematoma subdural.", "fratura de base de crânio.", "ratura linear de calvária.", "contusão cerebral difusa."],
  correta: 2,
...
// ─────────── SISTEMAS ───────────
{
  ...
  alts: ["Acidose respiratória parcialmente compensada por retenção renal de bicarbonato.", "Alcalose respiratória parcialmente compensada por eliminação de bicarbonato.", "Acidose metabólica compensada por hiperventilação e eliminação de CO₂.", "Alcalose metabólica compensada por hipoventilação e retenção de CO₂.", "Acidose respiratória totalmente compensada por mecanismos renais imediatos."],
  correta: 0,
  ...
  id: "fgv25-66",
  eixo: "seg",
  sub: "Controle de infecção hospitalar",
  banca: "FGV",
  ano: 2025,
  orgao: "ALE-AM",
  nivel: "media",
  ...
  alts: ["Manter o paciente em decúbito dorsal plano para otimizar o retorno venoso e evitar instabilidade hemodinâmica.", "Realizar aspiração traqueal rotineiramente em horários fixos, independentemente da necessidade clínica observada.", "Garantir pressão do cuff entre 50 e 60 cmH₂O, para evitar escape de ar e reduzir o risco de pneumonia associada à ventilação.", "Elevar a cabeceira do leito entre 30° e 45°, realizar higiene oral com antisséptico e manter sistema fechado de aspiração.", "Suspender a higiene oral durante períodos de instabilidade respiratória, para evitar aumento do esforço ventilatório e risco de dessaturação."],
  correta: 3,
...
// ─────────── ADMINISTRAÇÃO ───────────
{
  id: "fgv25-68",
  eixo: "admin",
  sub: "Dimensionamento de pessoal",
  banca: "FGV",
  ano: 2025,
  orgao: "ALE-AM",
  nivel: "dificil",
  ...
  alts: ["1 enfermeiro e 1 técnico de Enfermagem.", "1 enfermeiro e 2 técnicos de Enfermagem.", "1 enfermeiro e 3 técnicos de Enfermagem.", "2 enfermeiros e 2 técnicos de Enfermagem.", "2 enfermeiros e 3 técnicos de Enfermagem."],
  correta: 1,
...
// ─────────── URGÊNCIA ───────────
{
  ...
  alts: ["interromper a RCP por 10 segundos para checar o ritmo, realizar desfibrilação e administrar 300 mg de amiodarona EV.", "suspender a RCP e iniciar ventilação isolada com ambu, pois a assistolia não responde à compressão torácica.", "continuar a RCP por mais 2 minutos, administrar 1 mg de epinefrina a cada 3–5 minutos e reavaliar o ritmo após o ciclo.", "aplicar desfibrilação imediata e iniciar amiodarona EV, pois a ausência de pulso indica ritmo chocável.", "realizar pausa prolongada para verificar pulso e respiração, iniciando RCP apenas após nova confirmação da parada."],
  correta: 2,
  ...
  id: "fgv25-72",
  eixo: "admin",
  sub: "Gestão da qualidade e indicadores",
  banca: "FGV",
  ano: 2025,
  orgao: "ALE-AM",
  nivel: "media",
  ...
  id: "fgv25-73",
  eixo: "seg",
  sub: "Limpeza, desinfecção e esterilização",
  banca: "FGV",
  ano: 2025,
  orgao: "ALE-AM",
  nivel: "media",
  ...
  alts: ["nenhuma das variáveis deve ser definida antes da coleta, para não interferir nos resultados.", "o nível de estresse é uma variável independente, e a prática de atividade física é a variável dependente.", "ambas as variáveis são dependentes, pois podem variar conforme o humor dos participantes.", "as duas variáveis são independentes, já que uma não influencia a outra diretamente.", "a prática regular de atividade física é uma variável independente, e o nível de estresse é a variável dependente."],
  correta: 4,
  ...
  alts: ["autorização verbal do familiar de primeiro grau do paciente.", "confirmação clínica do óbito por parada cardiorrespiratória.", "solicitação formal do médico responsável pelo atendimento.", "consentimento familiar por escrito e confirmação da morte encefálica.", "autorização judicial emitida por perito do tribunal competente."],
  correta: 3,
  ...
  alts: ["o monitoramento do processo de esterilização com indicador biológico deve ser feito diariamente, em todas as cargas, em pacote teste desafio.", "é possível substituir o uso rotineiro de indicadores biológicos por integradores químicos classe 5, já que ambos avaliam simultaneamente os parâmetros críticos do processo.", "o teste para avaliar o desempenho do sistema de remoção de ar (Bowie & Dick) da autoclave assistida por bomba de vácuo é recomendado apenas em situações de urgência e emergência.", "o monitoramento com integradores químicos classe 5 ou 6 só deve ser realizado em situações críticas, quando houver falhas nos testes rotineiros.", "no monitoramento do processo de esterilização dos produtos implantáveis para saúde, deve ser adicionado um indicador biológico, a cada carga."],
  correta: 4,
  ...
  alts: ["padrão, pois a transmissão ocorre apenas pelo contato com superfícies contaminadas, sem necessidade de máscara.", "contato, pois o agente etiológico é transmitido por meio do toque direto com secreções ou pele não íntegra do paciente.", "gotícula, pois o agente é transmitido por secreções respiratórias expelidas ao falar, tossir ou espirrar a curta distância.", "aerossol, pois o agente permanece suspenso no ar por longos períodos, exigindo isolamento com pressão negativa.", "reforçada, pois a doença requer a combinação obrigatória de precauções padrão, de contato e por aerossóis simultaneamente."],
  correta: 2,
  ...
  alts: ["tubo laríngeo.", "cânula faríngea.", "máscara laríngea.", "cateter orofaríngeo.", "tubo traqueo-esofágico."],
  correta: 2,
  ...
  alts: ["presença de eritema, calor, dor local ao redor da incisão, ocorrendo até 30 dias após a cirurgia, com ou sem drenagem purulenta.", "inflamação envolvendo músculo ou fáscia, com abscesso profundo, ocorrendo em até 30 dias após a cirurgia.", "infecção limitada ao órgão ou espaço interno, sem envolvimento da incisão cirúrgica, ocorrendo até 90 dias após a cirurgia.", "presença de febre isolada, sem eritema, dor ou secreção na incisão, ocorrendo até 45 dias após a cirurgia.", "presença de febre, abcesso ou deiscência espontânea, ocorrendo até 20 dias após a cirurgia, com drenagem purulenta."],
  correta: 0,
  ...
  alts: ["Realizar contagem de compressas e instrumentais e checar antibiótico profilático.", "Revisar o nome completo do paciente, o consentimento informado e o local da cirurgia.", "Validar o registro do horário de início da cirurgia e assegurar a presença de exames complementares.", "Confirmar o funcionamento do aspirador cirúrgico, a disponibilidade de drenos e o preparo dos campos estéreis.", "Realizar o registro da equipe no prontuário e validar a conferência do material."],
  correta: 1,
...
// ─────────── SEMIOLOGIA E SAE ───────────
{
  id: "sel24-31",
  eixo: "semio",
  sub: "Sistematização da assistência (SAE)",
  banca: "SELECON",
  ano: 2024,
  orgao: "HEMOMINAS",
  nivel: "media",
  ...
  alts: ["Lei nº 7.498/1986, que regulamenta o exercício da enfermagem, enfatizando que o planejamento e a implementação da assistência são de responsabilidade exclusiva do técnico de enfermagem, liberando o enfermeiro para atividades administrativas", "Resolução Cofen nº 358/2009, que define a SAE como obrigatória em instituições públicas e privadas e orienta que o Processo de Enfermagem deve privilegiar a autonomia do enfermeiro no diagnóstico e no planejamento do cuidado", "Código de Ética dos Profissionais de Enfermagem, que solicita a implementação da SAE como responsabilidade moral dos enfermeiros, porém não impõe nenhuma exigência ou regulamentação sobre os aspectos técnicos da assistência", "Resolução Cofen nº 564/2017, que detalha os princípios éticos da profissão e regula diretamente a atuação da equipe de enfermagem no gerenciamento de conflitos no ambiente hospitalar sem priorizar a SAE"],
  correta: 1,
  ...
  alts: ["a etapa de planejamento consiste na identificação dos problemas de saúde baseados nos dados coletados", "o diagnóstico de enfermagem é dispensável quando se conhece previamente o histórico do paciente", "a avaliação finaliza o processo sem necessidade de revisão das intervenções já executadas", "a coleta de dados permite reunir informações objetivas e subjetivas que subsidiam as etapas seguintes"],
  correta: 3,
  ...
  alts: ["avaliação, diagnóstico, planejamento, implementação, coleta de dados", "coleta de dados, diagnóstico, planejamento, implementação, avaliação", "planejamento, coleta de dados, diagnóstico, implementação, avaliação", "diagnóstico, coleta de dados, planejamento, implementação, avaliação"],
  correta: 1,
  ...
  alts: ["a SAE é aplicada exclusivamente a pacientes hospitalizados, dado que a complexidade do processo impede sua utilização em serviços de atenção primária ou domiciliar", "a SAE tem como finalidade estabelecer a autonomia do enfermeiro em sua prática assistencial, excluindo profissionais de nível técnico ou auxiliar de sua implementação", "a SAE compreende cinco etapas distintas: coleta de dados, diagnóstico de enfermagem, planejamento, implementação e avaliação, sendo o diagnóstico uma etapa privativa do enfermeiro", "o planejamento da assistência dentro da SAE deve restringir-se unicamente a cuidados prescritos, não incluindo ações educativas ou de prevenção realizadas pelo enfermeiro"],
  correta: 2,
  ...
  alts: ["a SAE é exclusiva para os enfermeiros, enquanto os técnicos e auxiliares de enfermagem têm um papel restrito à coleta de dados e execução de tarefas operacionais", "a SAE é um processo linear cujo principal foco está na resolução imediata do problema do paciente, sem a necessidade de avaliações regulares após a implementação inicial do plano de cuidado", "a aplicação da SAE no ambiente hospitalar é obrigatória por lei e contribui para a melhoria da qualidade do cuidado, unificando o raciocínio clínico e garantindo continuidade nas ações de enfermagem", "a Resolução COFEN nº 358/2009 permite que o enfermeiro formule o diagnóstico de enfermagem usando apenas critérios subjetivos, desde que validados diretamente com o paciente"],
  correta: 2,
...
// ─────────── BIOÉTICA E LEGISLAÇÃO ───────────
{
  ...
  alts: ["a administração de medicamentos por vias de acesso periféricas em pacientes críticos internados em unidades de terapia intensiva (UTI)", "o ensino, a orientação e a supervisão de profissionais auxiliares e técnicos de enfermagem em instituições de saúde públicas ou privadas", "a realização de banho no leito em pacientes com mobilidade restrita em ambiente hospitalar", "o preparo e a administração de dietas enterais sob supervisão de um nutricionista em serviços ambulatoriais"],
  correta: 1,
...
// ─────────── SEGURANÇA DO PACIENTE E BIOSSEGURANÇA ───────────
{
  ...
  alts: ["administração seletiva de antibióticos de amplo espectro no pré-operatório imediato", "tricotomia capilar com lâmina de barbear em todas as áreas a serem incisadas", "antissepsia das mãos da equipe cirúrgica, com técnica padronizada e solução alcoólica", "utilização de vestimentas cirúrgicas reutilizáveis, previamente esterilizadas em autoclave"],
  correta: 2,
  ...
  alts: ["prescrição de antibióticos de amplo espectro em todas as infecções suspeitas", "utilização de antibióticos de última geração em todas as infecções", "realização de culturas e testes de sensibilidade aos antibióticos antes do início da terapia", "administração profilática de antibióticos em todos os pacientes internados"],
  correta: 2,
  ...
  alts: ["a higienização das mãos com álcool em gel substitui completamente a lavagem com água e sabão em todas as situações", "a lavagem das mãos deve ser feita, obrigatoriamente, antes e após o contato com o paciente, mas não é necessária ao manusear dispositivos médicos esterilizados", "a utilização de dispositivos médicos descartáveis elimina a necessidade de higienizar as mãos antes do uso", "a higienização das mãos deve ser realizada antes de procedimentos invasivos, como punções venosas, e após o contato com material biológico"],
  correta: 3,
  ...
  alts: ["o uso de luvas pode ser dispensado ao realizar procedimentos com risco de contato com fluidos corporais, desde que as mãos estejam devidamente higienizadas", "a higienização das mãos deve ser realizada apenas antes do atendimento ao paciente em precauções padrão", "o uso de equipamentos de proteção individual (EPIs) é obrigatório apenas em precauções de contato, e não se aplica às precauções padrão", "as precauções padrão devem ser aplicadas a todos os pacientes, independentemente do diagnóstico ou da presunção de infecção"],
  correta: 3,
...
// ─────────── ASSISTÊNCIA POR SISTEMAS ───────────
{
  ...
  alts: ["a ECG avalia a profundidade do coma considerando três parâmetros: resposta visual, resposta auditiva e resposta motora", "a pontuação máxima na ECG é 15, indicando um paciente em coma profundo", "a ECG avalia três parâmetros: abertura ocular, resposta verbal e resposta motora, com a pontuação mínima sendo 3", "em caso de paciente intubado, a avaliação da ECG deve ser suspensa, pois não é possível aplicar os critérios da escala"],
  correta: 2,
  ...
  alts: ["a monitorização da glicemia capilar deve ser realizada apenas uma vez ao dia, preferencialmente em jejum, para avaliar o controle glicêmico do paciente", "a orientação para o autocuidado inclui instruções sobre a administração correta de insulina, cuidados com os pés, alimentação adequada e reconhecimento de sinais de hipoglicemia e hiperglicemia", "a administração de insulina pode ser realizada em qualquer local do corpo, desde que a rotação dos locais de aplicação não seja uma preocupação principal", "a educação em saúde para pacientes diabéticos deve focar exclusivamente no controle alimentar, sendo desnecessário abordar a importância da atividade física regular"],
  correta: 1,
  ...
  alts: ["a monitorização do balanço hídrico é irrelevante em pacientes com insuficiência cardíaca, pois a retenção de líquidos não afeta significativamente a condição clínica", "a administração de diuréticos deve ser feita sem considerar a monitorização dos eletrólitos, uma vez que as alterações eletrolíticas não são comuns nesses pacientes", "a orientação ao paciente sobre a importância do controle da ingestão de sódio e a adesão ao tratamento medicamentoso é fundamental para a prevenção de exacerbações da insuficiência cardíaca", "a prática de exercícios físicos intensos é recomendada para todos os pacientes com insuficiência cardíaca, independentemente do estágio da doença, para melhorar a função cardíaca"],
  correta: 2,
  ...
  alts: ["a administração de diuréticos deve ser evitada em pacientes com ascite, pois pode agravar a retenção de líquidos e aumentar o risco de peritonite bacteriana espontânea", "a monitorização dos níveis de amônia sanguínea é irrelevante, uma vez que a encefalopatia hepática não está diretamente relacionada à concentração de amônia no sangue", "a orientação ao paciente sobre a restrição de sódio na dieta é fundamental para controlar a ascite e prevenir a retenção hídrica", "a realização de paracentese terapêutica é indicada apenas em casos de ascite refratária e deve ser evitada em pacientes com coagulopatia, independentemente do grau de severidade"],
  correta: 2,
  ...
  alts: ["a orientação sobre o uso correto dos dispositivos inalatórios é crucial para garantir a eficácia do tratamento e prevenir exacerbações", "a monitorização do pico de fluxo expiratório é desnecessária na avaliação do controle da asma, sendo suficiente a avaliação clínica dos sintomas", "a administração de corticosteroides inalatórios deve ser evitada, pois seu uso prolongado pode levar ao desenvolvimento de dependência e efeitos colaterais sistêmicos graves", "a exposição a alérgenos deve ser minimizada apenas durante as crises asmáticas, sendo desnecessário adotar medidas preventivas em períodos de controle da doença"],
  correta: 0,
...
// ─────────── CICLOS DE VIDA ───────────
{
  ...
  alts: ["a eritroblastose fetal ocorre apenas quando a mãe tem sangue ABO incompatível com o do feto, independentemente do fator Rh", "mulheres Rh negativo podem desenvolver anticorpos anti-D contra o sangue do feto Rh positivo, colocando gestações subsequentes em risco", "o uso de imunoglobulina anti-D durante a gestação é contra-indicado, pois favorece a formação de anticorpos maternos contra o fator Rh", "o fator Rh não apresenta relevância na gestação e não pode interferir na saúde do feto e da mãe"],
  correta: 1,
...
// ─────────── ADMINISTRAÇÃO EM ENFERMAGEM ───────────
{
  ...
  alts: ["o cuidado primário concentra-se exclusivamente em intervenções curativas voltadas às emergências", "os serviços de enfermagem em atenção primária buscam a promoção da saúde, prevenção de agravos e acompanhamento longitudinal", "a enfermagem em atenção terciária não participa do gerenciamento das condições clínicas, atuando apenas na reabilitação", "a organização dos serviços de enfermagem limita-se à execução de tarefas operacionais, sem envolvimento no planejamento estratégico"],
  correta: 1,
  ...
  id: "sel24-39",
  eixo: "admin",
  sub: "Liderança e trabalho em equipe",
  banca: "SELECON",
  ano: 2024,
  orgao: "HEMOMINAS",
  nivel: "facil",
  ...
  alts: ["o enfermeiro atua como líder técnico, delegando atividades sem a necessidade de supervisão sistemática", "a organização dos serviços reduz o papel do enfermeiro a ações operacionais, restringindo sua atuação no processo de planejamento", "o trabalho em equipe em enfermagem ocorre exclusivamente em ambientes hospitalares, sem importância nos serviços comunitários", "a liderança em enfermagem envolve o estímulo ao trabalho em equipe, a tomada de decisão compartilhada e a gestão eficaz dos conflitos"],
  correta: 3,
  ...
  alts: ["a avaliação de desempenho da equipe de enfermagem é uma responsabilidade do enfermeiro gerente, que deve utilizar critérios objetivos e subjetivos para promover o desenvolvimento profissional e a qualidade da assistência", "o enfermeiro gerente é responsável exclusivamente pela supervisão direta da assistência prestada, não se envolvendo na gestão de recursos materiais e financeiros da unidade", "a elaboração de escalas de trabalho é uma atribuição que deve ser realizada de maneira fixa e imutável, sem considerar as necessidades individuais dos profissionais e as demandas da unidade", "a comunicação eficaz é irrelevante para a gerência em enfermagem, uma vez que as decisões gerenciais são tomadas exclusivamente pelo enfermeiro gerente sem a necessidade de interação com a equipe"],
  correta: 0,
  ...
  alts: ["a Teoria Clássica da Administração, proposta por Henri Fayol, enfatiza a importância da flexibilidade e da adaptação às mudanças, priorizando a descentralização das decisões e a autonomia dos trabalhadores", "a Teoria das Relações Humanas, desenvolvida por Elton Mayo, destaca a importância dos aspectos emocionais e das relações interpessoais no ambiente de trabalho, promovendo a satisfação e o bem-estar dos profissionais", "a Teoria da Contingência, de Fiedler, defende que não existe uma única maneira ideal de organizar e gerenciar uma equipe, sendo necessário adotar um estilo de liderança rígido e autocrático para garantir a eficiência", "a Teoria X e Y, de Douglas McGregor, sugere que os trabalhadores são naturalmente desmotivados e necessitam de controle rigoroso e de supervisão constante para desempenhar suas funções adequadamente"],
  correta: 1,
...
// ─────────── BIOÉTICA E LEGISLAÇÃO ───────────
{
  ...
  alts: ["participação no planejamento, na execução e na avaliação da programação de saúde", "prescrição de medicamentos previamente estabelecidos em programas de saúde pública", "prestação de assistência de enfermagem à gestante, à parturiente, à puérpera e ao recém-nascido", "realização de cuidados de maior complexidade técnica e que exijam conhecimentos científicos adequados e capacidade de tomar decisões imediatas"],
  correta: 3,
...
// ─────────── ADMINISTRAÇÃO EM ENFERMAGEM ───────────
{
  ...
  alts: ["visão, autoconfiança, autoestima e consciência", "consciência, confiança, autoestima e comunicação", "visão, confiança, autoestima positiva e comunicação", "consciência, autoconfiança, autoestima positiva e comunicação"],
  correta: 2,
...
// ─────────── URGÊNCIA ───────────
{
  ...
  alts: ["universalidade, equidade e integralidade", "universalidade, acesso e integralidade", "equidade, acesso e universalidade", "equidade, acesso e integralidade"],
  correta: 0,
...
// ─────────── BÔNUS: SAÚDE COLETIVA ───────────
{
  ...
  alts: ["capacitar os profissionais de saúde", "fortalecer as instituições de saúde", "priorizar a prevenção", "ampliar o diagnóstico"],
  correta: 1,
...
// ─────────── SEMIOLOGIA E SAE ───────────
{
  ...
  banca: "FUNDATEC",
  ano: 2024,
  orgao: "Pref. Coqueiral/MG",
  nivel: "facil",
  enunciado: "Qual das alternativas abaixo apresenta um dos objetivos da Sistematização da Assistência de Enfermagem (SAE)?",
  alts: ["Reduzir o tempo gasto com a documentação de enfermagem.", "Padronizar os cuidados de enfermagem para garantir qualidade e segurança ao paciente.", "Minimizar a comunicação entre os membros da equipe de saúde.", "Eliminar a necessidade de avaliação contínua do paciente.", "Aumentar a carga de trabalho dos profissionais de enfermagem."],
  correta: 1,
  ...
  alts: ["voluntária, pois a família consentiu em nome do paciente, que se encontra incapaz de decidir.", "compulsória, uma vez que o paciente apresenta risco a terceiros e recusa o tratamento.", "involuntária, devendo ser comunicada ao Ministério Público em até 72 horas.", "involuntária, devendo ser comunicada ao juiz competente em até 24 horas.", "voluntária, desde que o paciente assine o termo após a estabilização do quadro."],
  correta: 2,
  ...
  alts: ["O CAPS I atende municípios com população acima de 70 mil habitantes e funciona 24 horas.", "O CAPS III funciona 24 horas e dispõe de acolhimento noturno, sendo indicado para municípios com população acima de 150 mil habitantes.", "O CAPS AD destina-se exclusivamente a crianças e adolescentes usuários de álcool e outras drogas.", "O acolhimento noturno realizado no CAPS III configura internação psiquiátrica de curta duração.", "O acesso ao CAPS ocorre exclusivamente por encaminhamento médico da atenção básica."],
  correta: 1,
  ...
  alts: ["confrontar a paciente com evidências concretas, demonstrando que não existem câmeras no local.", "concordar com o relato da paciente, a fim de estabelecer vínculo terapêutico e reduzir a agitação.", "ignorar o conteúdo do relato e redirecionar imediatamente a conversa para outro assunto.", "acolher o sentimento expresso pela paciente, sem afirmar nem negar o conteúdo do delírio.", "solicitar contenção mecânica preventiva, considerando o risco iminente de agitação psicomotora."],
  correta: 3,
  ...
  alts: ["O receio da enfermeira é procedente: abordar diretamente a ideação suicida pode induzir o comportamento em pessoas vulneráveis.", "A enfermeira deve perguntar de forma direta e acolhedora sobre a ideação suicida, pois a abordagem reduz a angústia e permite intervir.", "A conduta correta é encaminhar imediatamente ao CAPS sem abordar o tema, evitando exposição desnecessária da usuária.", "A abordagem só deve ocorrer na presença de um profissional médico ou psicólogo, por se tratar de competência exclusiva desses profissionais.", "A enfermeira deve orientar a família a vigiar a usuária, sem comunicar a ela essa observação, para não gerar constrangimento."],
  correta: 1,
  ...
  alts: ["restringe-se ao impedimento de natureza física, sensorial ou intelectual, considerado isoladamente.", "resulta da interação entre impedimentos de longo prazo e as barreiras que obstruem a participação plena na sociedade.", "é definido exclusivamente por avaliação médica que ateste a limitação funcional do indivíduo.", "implica, necessariamente, restrição da capacidade civil da pessoa para os atos da vida.", "abrange apenas os impedimentos congênitos, excluindo os adquiridos ao longo da vida."],
  correta: 1,
  ...
  id: "aut-mental-06",
  eixo: "mental",
  sub: "Situação de risco e violência",
  banca: "Autoral Resifriends",
  estilo: "AOCP",
  ano: 2026,
  autoral: true,
  ...
  alts: ["a notificação depende da autorização expressa da usuária, devendo ser respeitada sua recusa.", "a notificação é compulsória e independe da vontade da usuária, sendo ainda obrigatória a comunicação à autoridade policial em até 24 horas.", "a notificação só é obrigatória em serviços públicos, não se aplicando à rede privada.", "a notificação deve aguardar a confirmação da agressão por exame de corpo de delito.", "por se tratar de recusa da usuária, cabe ao serviço apenas registrar o atendimento clínico em prontuário."],
  correta: 1,
  ...
  alts: ["AD 1, sob responsabilidade da equipe de atenção básica, por apresentar quadro estável.", "AD 2, sob responsabilidade da EMAD, por necessitar de cuidados de maior frequência.", "AD 3, sob responsabilidade da EMAD, por demandar equipamento de maior complexidade.", "AD 3, sob responsabilidade da atenção básica, desde que haja apoio da EMAP.", "não é elegível à atenção domiciliar, devendo permanecer internado em unidade hospitalar."],
  correta: 2,
  ...
  alts: ["Os Serviços Residenciais Terapêuticos (SRT) integram as estratégias de desinstitucionalização.", "Os leitos de saúde mental em hospital geral integram o componente de atenção hospitalar.", "As Unidades de Acolhimento compõem a atenção residencial de caráter transitório.", "O hospital psiquiátrico especializado constitui o principal ponto de atenção da rede.", "Os Centros de Convivência integram o componente da atenção básica em saúde."],
  correta: 3,
  ...
  alts: ["A contenção pode ser realizada por qualquer profissional da equipe, desde que registrada em prontuário.", "A aplicação da contenção mecânica se dará sob supervisão direta do enfermeiro, devendo ser o único meio disponível para prevenir dano imediato ou iminente.", "A contenção mecânica é indicada preventivamente em pacientes com histórico de agitação, independentemente do quadro atual.", "A duração da contenção deve ser de no mínimo 24 horas, para garantir a estabilização do quadro.", "A contenção mecânica pode ser empregada por conveniência da equipe quando houver déficit de pessoal no plantão."],
  correta: 1,
  ...
  alts: ["Ter acesso ao melhor tratamento do sistema de saúde, consentâneo às suas necessidades.", "Ser tratada com humanidade e respeito, no interesse exclusivo de beneficiar sua saúde.", "Ter livre acesso aos meios de comunicação disponíveis.", "Ser tratada, preferencialmente, em instituição hospitalar especializada de longa permanência.", "Receber o maior número de informações a respeito de sua doença e de seu tratamento."],
  correta: 3,
  ...
  alts: ["episódio depressivo maior com sintomas atípicos.", "transtorno de ansiedade generalizada em fase aguda.", "episódio maníaco no contexto de transtorno afetivo bipolar.", "transtorno de personalidade histriônica descompensado.", "esquizofrenia em fase produtiva com sintomas positivos."],
  correta: 2,
  ...
  alts: ["Oferecer conselhos e soluções prontas demonstra acolhimento e reduz a angústia do paciente.", "O uso do silêncio deve ser evitado, pois transmite desinteresse e desconforto ao paciente.", "Perguntas abertas favorecem a expressão do paciente e ampliam a compreensão do seu sofrimento.", "Frases como 'não se preocupe, vai dar tudo certo' validam os sentimentos e fortalecem o vínculo.", "Mudar de assunto diante de temas difíceis protege o paciente de sofrimento adicional."],
  correta: 2,
  ...
  alts: ["O atendimento deve ser condicionado à apresentação de boletim de ocorrência e laudo do IML.", "A profilaxia pós-exposição (PEP) para o HIV deve ser iniciada, pois o atendimento ocorre dentro da janela de 72 horas, com duração de 28 dias.", "A contracepção de emergência é contraindicada em adolescentes menores de 18 anos.", "A notificação ao SINAN deve ser realizada em até 7 dias, conforme prazo geral da lista de notificação compulsória.", "A profilaxia para sífilis só deve ser realizada após resultado reagente do teste rápido."],
  correta: 1,
  ...
  alts: ["barreira urbanística, por dificultar o acesso ao serviço de saúde.", "barreira arquitetônica, relacionada à estrutura do estabelecimento.", "barreira atitudinal, por presumir a incapacidade do usuário e desrespeitar sua autonomia.", "barreira tecnológica, por não utilizar recursos de comunicação alternativa.", "conduta adequada, uma vez que o acompanhante pode fornecer informações mais precisas."],
  correta: 2,
  ...
  alts: ["A elegibilidade do paciente independe da existência de cuidador, cabendo à equipe suprir integralmente essa função.", "A modalidade AD 1 é de responsabilidade da Equipe Multiprofissional de Atenção Domiciliar (EMAD).", "São requisitos para a AD a estabilidade clínica, a presença de cuidador identificado e a concordância da família.", "Pacientes em estado crítico e instabilidade hemodinâmica são elegíveis, desde que haja suporte da EMAP.", "A Equipe Multiprofissional de Apoio (EMAP) é a responsável direta pelas modalidades AD 2 e AD 3."],
  correta: 2,
  ...
  alts: ["A Lei nº 10.216/2001 determinou o fechamento imediato de todos os hospitais psiquiátricos do país.", "A lei redireciona o modelo assistencial em saúde mental e prevê a substituição progressiva dos leitos em hospitais psiquiátricos por uma rede de serviços comunitários.", "O movimento da Reforma Psiquiátrica teve origem exclusivamente na iniciativa do Poder Executivo federal, sem participação da sociedade civil.", "A internação psiquiátrica foi proibida em qualquer circunstância pela referida lei.", "A lei estabelece que o tratamento tem como finalidade permanente a contenção dos sintomas, sem previsão de reinserção social."],
  correta: 1,
  ...
  alts: ["intoxicação alcoólica aguda, devendo-se aguardar a metabolização espontânea.", "síndrome de abstinência alcoólica, quadro que pode evoluir para convulsões e delirium tremens.", "reação adversa a medicamento, devendo-se suspender toda a terapêutica em curso.", "transtorno de ansiedade generalizada, sem relação com a interrupção do consumo.", "simulação de sintomas com o objetivo de obter benefício secundário no serviço."],
  correta: 1,
  ...
  alts: ["física, psicológica, sexual, patrimonial e moral.", "física, psicológica, sexual, institucional e simbólica.", "física, sexual, moral, estrutural e patrimonial.", "física, psicológica, sexual, moral e obstétrica.", "física, psicológica, patrimonial, moral e digital."],
  correta: 0,
  ...
  alts: ["É elaborado exclusivamente pelo profissional de nível superior de referência, sem participação da equipe.", "Constitui documento padronizado, aplicável de forma idêntica a usuários com o mesmo diagnóstico.", "É construído de forma compartilhada com o usuário e sua rede de apoio, considerando sua singularidade.", "Sua finalidade é estabelecer prescrições médicas de longo prazo, dispensando reavaliações.", "Deve ser mantido em sigilo do usuário, para não interferir na sua adesão ao tratamento."],
  correta: 2,
  ...
  alts: ["Os Serviços Residenciais Terapêuticos (SRT) são unidades hospitalares de longa permanência destinadas a pacientes crônicos.", "O Programa De Volta Para Casa institui auxílio-reabilitação psicossocial para pessoas egressas de longas internações psiquiátricas.", "As Unidades de Acolhimento destinam-se à internação compulsória de usuários de álcool e outras drogas.", "A desinstitucionalização consiste na simples desativação dos leitos psiquiátricos, sem necessidade de serviços substitutivos.", "Os SRT devem ser localizados dentro do perímetro de hospitais psiquiátricos, para facilitar o acompanhamento clínico."],
  correta: 1,
  ...
  alts: ["será feito com rifampicina e dapsona por 6 meses, sem uso de clofazimina, por se tratar de forma paucibacilar.", "será feito com poliquimioterapia única (PQT-U) — rifampicina, dapsona e clofazimina — em 6 doses supervisionadas.", "será feito com poliquimioterapia única (PQT-U) em 12 doses supervisionadas, independentemente da classificação operacional.", "deve ser iniciado somente após confirmação por baciloscopia positiva.", "exige isolamento respiratório da paciente durante todo o período de tratamento."],
  correta: 1,
  ...
  alts: ["A pessoa com ILTB transmite o bacilo e deve ser mantida em precaução por aerossóis.", "O tratamento da ILTB é realizado com o esquema RIPE por seis meses.", "O esquema 3HP consiste em rifapentina associada à isoniazida, administradas semanalmente por 12 semanas.", "O tratamento preventivo pode ser iniciado sem a necessidade de excluir tuberculose ativa.", "A prova tuberculínica é o único método aceito para o diagnóstico da ILTB no SUS."],
  correta: 2,
  ...
  alts: ["A, devendo receber hidratação oral em domicílio.", "B, devendo permanecer na unidade até o resultado do hemograma.", "C, devendo receber hidratação venosa imediata e ser internado.", "D, devendo ser encaminhado à unidade de terapia intensiva.", "B, uma vez que a remissão da febre indica melhora do quadro."],
  correta: 2,
  ...
  alts: ["deve-se substituir a penicilina por doxiciclina, mantendo a eficácia do tratamento para o feto.", "a gestante deve ser submetida à dessensibilização à penicilina, pois esta é o único tratamento que trata adequadamente o feto.", "o tratamento deve ser adiado até o terceiro trimestre, quando o risco de reação é menor.", "a azitromicina é a alternativa de escolha em gestantes alérgicas à penicilina.", "o tratamento é dispensável, uma vez que o VDRL 1:16 indica cicatriz sorológica."],
  correta: 1,
  ...
  alts: ["Devem ser iniciados apenas quando esgotadas todas as possibilidades de tratamento modificador da doença.", "Consistem na antecipação da morte para abreviar o sofrimento do paciente em fase terminal.", "Devem ser iniciados precocemente, podendo ser conduzidos concomitantemente ao tratamento modificador da doença.", "Restringem-se ao controle da dor física, não abrangendo aspectos psicossociais e espirituais.", "Excluem o suporte à família, cujo acompanhamento cabe exclusivamente ao serviço social."],
  correta: 2,
  ...
  alts: ["anualmente, para todas as mulheres a partir da menarca, independentemente de atividade sexual.", "em mulheres de 25 a 64 anos que já tiveram atividade sexual, a cada três anos após dois exames anuais consecutivos negativos.", "em mulheres de 20 a 59 anos, com periodicidade bienal, independentemente dos resultados anteriores.", "semestralmente, em todas as mulheres com vida sexual ativa, para detecção precoce de lesões.", "apenas em mulheres com sintomas ginecológicos ou histórico familiar de neoplasia."],
  correta: 1,
  ...
  alts: ["trata-se de neutropenia febril, considerada emergência oncológica, devendo-se iniciar antibioticoterapia precocemente.", "a conduta adequada é observar por 24 horas, uma vez que a febre isolada não indica gravidade em pacientes oncológicos.", "deve-se aguardar o resultado da hemocultura antes de iniciar qualquer antimicrobiano, para não mascarar o agente.", "a antibioticoterapia está contraindicada, pois a neutropenia impede a resposta ao tratamento.", "o quadro é esperado e não requer intervenção, tratando-se de efeito adverso benigno da quimioterapia."],
  correta: 0,
  ...
  alts: ["a nutrição parenteral é a escolha, por evitar o risco de broncoaspiração.", "a nutrição enteral é a escolha, pois o trato gastrointestinal está funcionante.", "a via oral deve ser mantida com espessantes, independentemente do grau de disfagia.", "a nutrição parenteral periférica é preferível à enteral em pacientes neurológicos.", "deve-se aguardar a recuperação neurológica antes de definir a via de nutrição."],
  correta: 1,
  ...
  alts: ["É indicada após exposição de risco, devendo ser iniciada em até 72 horas.", "Consiste no uso contínuo de antirretrovirais por pessoas sob risco aumentado de infecção, antes da exposição.", "Substitui integralmente o uso do preservativo, protegendo contra todas as IST.", "É indicada exclusivamente para pessoas vivendo com HIV, como forma de reduzir a carga viral.", "Tem duração fixa de 28 dias, independentemente da manutenção do risco."],
  correta: 1,
  ...
  id: "aut-doencas-10",
  eixo: "doencas",
  sub: "Crônicas não transmissíveis",
  banca: "Autoral Resifriends",
  estilo: "FGV",
  ano: 2026,
  autoral: true,
  ...
  alts: ["Os principais fatores de risco modificáveis são idade, sexo e hereditariedade.", "O cuidado às DCNT caracteriza-se por intervenções pontuais e episódicas, centradas na crise.", "Tabagismo, álcool, inatividade física e alimentação inadequada são fatores de risco modificáveis comuns aos principais grupos de DCNT.", "A adesão ao tratamento depende exclusivamente da vontade individual do usuário, cabendo à equipe apenas informar.", "O rastreamento populacional é contraindicado nas DCNT, por gerar sobrediagnóstico."],
  correta: 2,
  ...
  alts: ["suspender definitivamente a rifampicina e comunicar a equipe médica para substituição do esquema.", "orientar que a coloração alaranjada da urina é efeito esperado da rifampicina, reforçando a importância de não interromper o tratamento.", "encaminhar imediatamente o paciente para avaliação de função renal, por suspeita de nefrotoxicidade.", "reduzir a dose da rifampicina pela metade até a normalização da coloração urinária.", "manter a suspensão até avaliação médica, uma vez que a alteração indica reação adversa maior."],
  correta: 1,
  ...
  alts: ["A parotidite (caxumba) foi incluída na lista, com notificação semanal.", "A febre do Oropouche foi incluída, com notificação semanal para os casos e imediata em óbitos e gestantes.", "A covid-19 permanece como item isolado da lista, com notificação imediata.", "A difteria passou a ter notificação semanal, dado o controle vacinal alcançado no país.", "O tétano acidental foi excluído da lista nacional de notificação compulsória."],
  correta: 1,
  ...
  alts: ["os opioides devem ser reservados exclusivamente para os últimos dias de vida, pelo risco de dependência.", "a analgesia deve ser administrada em horários fixos, com doses de resgate disponíveis para a dor irruptiva.", "o degrau inicial contempla opioides fortes, reservando-se os anti-inflamatórios para a dor refratária.", "a via intramuscular é a preferencial para o controle da dor crônica oncológica.", "a dor deve ser avaliada exclusivamente por parâmetros objetivos, como frequência cardíaca e pressão arterial."],
  correta: 1,
  ...
  alts: ["É transmitida principalmente por via parenteral e sexual, apresentando elevada taxa de cronificação.", "É de transmissão fecal-oral, geralmente autolimitada, e prevenível por vacinação disponível no SUS.", "Evolui para cirrose e carcinoma hepatocelular na maioria dos casos não tratados.", "A vacinação está indicada apenas para profissionais de saúde e manipuladores de alimentos.", "O diagnóstico é firmado exclusivamente por biópsia hepática."],
  correta: 1,
  ...
  alts: ["retirar imediatamente o cateter e massagear o local para dispersar o extravasado.", "interromper a infusão, manter o cateter, aspirar o resíduo e aplicar compressa fria.", "interromper a infusão, manter o cateter, aspirar o resíduo e aplicar compressa morna.", "reduzir o gotejamento e completar a infusão, mantendo observação do local.", "elevar o membro e manter a infusão em velocidade menor até o término da dose."],
  correta: 1,
  ...
  alts: ["a profundidade deve ser de pelo menos 5 cm, sem limite máximo estabelecido.", "a frequência deve ser de 100 a 120 compressões por minuto, com profundidade de 5 a 6 cm e retorno completo do tórax.", "as interrupções para checagem de pulso devem ocorrer a cada 1 minuto, com duração máxima de 30 segundos.", "a fração de compressão torácica ideal é de, no máximo, 40% do tempo total do atendimento.", "em pacientes obesos, a profundidade deve ser aumentada para 7 a 8 cm."],
  correta: 1,
  ...
  alts: ["A via endotraqueal é a preferencial para administração de fármacos durante a PCR, na indisponibilidade de acesso intravenoso.", "A vasopressina, isolada ou associada à adrenalina, demonstrou benefício adicional e deve ser incorporada ao protocolo.", "A via intravenosa é a de escolha para fármacos; na indisponibilidade, utiliza-se a via intraóssea.", "A desfibrilação sequencial dupla é recomendada de rotina na FV refratária após três choques.", "A RCP com elevação da cabeça é recomendada rotineiramente por melhorar a perfusão cerebral."],
  correta: 2,
  ...
  alts: ["garantir a permeabilidade da via aérea com proteção da coluna cervical.", "controlar a hemorragia externa exsanguinante por compressão direta ou torniquete.", "obter dois acessos venosos calibrosos e iniciar infusão de cristaloide aquecido.", "avaliar a expansibilidade torácica e auscultar os campos pulmonares.", "determinar o escore da Escala de Coma de Glasgow e avaliar as pupilas."],
  correta: 1,
  ...
  alts: ["Deve ser afrouxado a cada 15 minutos, para permitir a perfusão do membro e evitar isquemia.", "Deve ser aplicado 5 a 8 cm acima da lesão, apertado até a cessação do pulso distal, com registro do horário de aplicação.", "É contraindicado em amputações traumáticas, devendo-se optar exclusivamente pela compressão direta.", "Deve ser aplicado sobre a roupa da vítima, para reduzir o desconforto causado pela compressão.", "Constitui medida de último recurso, somente após falha de duas tentativas de compressão direta e packing."],
  correta: 1,
  ...
  alts: ["O atendimento é organizado por ordem de chegada, garantindo a equidade entre os usuários.", "A cor vermelha indica atendimento imediato, e a azul, menor prioridade.", "A classificação de risco é atribuição privativa do profissional médico.", "A cor verde indica risco iminente de morte, exigindo atendimento em até 10 minutos.", "O paciente classificado como azul deve ser mantido em observação contínua na sala vermelha."],
  correta: 1,
  ...
  id: "aut-urg-06",
  eixo: "urg",
  sub: "Atendimento pré-hospitalar",
  banca: "Autoral Resifriends",
  estilo: "IAUPE",
  ano: 2026,
  autoral: true,
  ...
  alts: ["a assistência de enfermagem no Suporte Avançado de Vida (SAV) é privativa do enfermeiro.", "o auxiliar de enfermagem compõe a tripulação mínima da unidade de Suporte Básico de Vida (SBV).", "o técnico de enfermagem pode prestar assistência no SAV, desde que sob supervisão à distância do enfermeiro.", "a remoção simples de paciente sem risco de morte exige a presença obrigatória do enfermeiro.", "o Suporte Intermediário de Vida (SIV) pode ser executado exclusivamente pelo técnico de enfermagem."],
  correta: 0,
  ...
  id: "aut-urg-08",
  eixo: "urg",
  sub: "Transporte do paciente de risco",
  banca: "Autoral Resifriends",
  estilo: "AOCP",
  ano: 2026,
  autoral: true,
  ...
  alts: ["O transporte é atribuição exclusiva do serviço de maqueiros, cabendo à enfermagem apenas a liberação do paciente.", "O transporte de pacientes hospitalizados é competência da equipe de enfermagem, cabendo ao enfermeiro o planejamento, a coordenação e a supervisão.", "A avaliação do risco-benefício é dispensável quando o exame solicitado é de caráter diagnóstico.", "O paciente instável deve ser transportado imediatamente, priorizando-se a realização do exame sobre a estabilização.", "As intercorrências ocorridas durante o transporte devem ser comunicadas verbalmente, sendo dispensável o registro."],
  correta: 1,
  ...
  alts: ["a prioridade é obter acesso venoso e administrar morfina para alívio imediato da dor.", "o eletrocardiograma de 12 derivações deve ser realizado em até 10 minutos da chegada.", "a oxigenoterapia deve ser instituída rotineiramente a todos os pacientes com suspeita de infarto.", "deve-se aguardar o resultado da troponina antes de qualquer intervenção terapêutica.", "a deambulação assistida está indicada para avaliar a tolerância ao esforço."],
  correta: 1,
  ...
  alts: ["hidrocortisona, por via intravenosa.", "difenidramina, por via intramuscular.", "adrenalina, por via intramuscular na face anterolateral da coxa.", "adrenalina, por via subcutânea no braço.", "salbutamol, por via inalatória."],
  correta: 2,
  ...
  alts: ["O choque hipovolêmico é o mais comum e sua conduta inicial é a administração de drogas vasoativas.", "No choque cardiogênico, a causa é a perda de volume intravascular, sendo a reposição volêmica vigorosa a conduta prioritária.", "No choque distributivo em fase inicial, a pele pode apresentar-se quente e corada, apesar do quadro de choque.", "O choque obstrutivo decorre de vasodilatação sistêmica intensa, como na sepse e na anafilaxia.", "A presença de pele fria e pegajosa exclui o diagnóstico de choque séptico."],
  correta: 2,
  ...
  alts: ["as áreas indolores indicam menor gravidade, por preservação das terminações nervosas.", "as áreas de aspecto branco-nacarado e indolor correspondem a queimadura de terceiro grau.", "a superfície corporal queimada deve incluir as lesões de primeiro grau no cálculo.", "a presença de flictenas caracteriza queimadura de primeiro grau.", "a queimadura de segundo grau é indolor por acometer a derme profunda."],
  correta: 1,
  ...
  alts: ["encorajar a tosse e observar, pois a obstrução é leve.", "realizar cinco golpes nas costas seguidos de cinco compressões abdominais, alternando até a desobstrução.", "iniciar imediatamente a manobra de Heimlich, sem medidas prévias.", "realizar varredura digital da cavidade oral para localizar e remover o corpo estranho.", "posicionar a vítima em decúbito dorsal e iniciar compressões torácicas."],
  correta: 1,
  ...
  alts: ["A assistolia e a atividade elétrica sem pulso (AESP) são ritmos chocáveis, devendo-se realizar desfibrilação imediata.", "Na fibrilação ventricular, a adrenalina deve ser administrada antes do primeiro choque.", "Após a desfibrilação, deve-se checar imediatamente o pulso antes de retomar as compressões.", "Na assistolia, a conduta é RCP de alta qualidade associada à adrenalina precoce e à busca de causas reversíveis.", "A atividade elétrica sem pulso caracteriza-se pela ausência total de atividade elétrica no monitor."],
  correta: 3,
...
// ═══════════ AUTORAIS: SEGURANÇA DO PACIENTE ═══════════
{
  ...
  alts: ["a borda do campo estéril, em toda a sua extensão, é considerada área estéril e pode receber material.", "objetos estéreis mantidos abaixo do nível da cintura do profissional permanecem estéreis se cobertos.", "uma vez aberto, o campo estéril só é considerado contaminado se houver contato visível com fluidos.", "a área compreendida na faixa de 2,5 cm da borda do campo é considerada não estéril (zona de contaminação).", "o profissional pode virar as costas para o campo estéril desde que mantenha as mãos enluvadas elevadas."],
  correta: 3,
  ...
  alts: ["Após tocar superfícies próximas ao paciente, mesmo sem ter tocado o paciente.", "Somente antes de procedimentos invasivos, dispensada nos demais contatos.", "Apenas após a retirada das luvas, já que a luva substitui a higienização prévia.", "Exclusivamente ao entrar e ao sair da unidade de internação, uma vez por turno.", "A cada duas horas, independentemente do contato com pacientes ou superfícies."],
  correta: 0,
  ...
  alts: ["o profissional deve espremer vigorosamente o local para expelir o máximo de sangue possível.", "a agulha deve ser reencapada com as duas mãos antes do descarte para evitar novo acidente.", "a conduta inclui lavar o local com água e sabão e notificar imediatamente, avaliando profilaxia pós-exposição.", "não há necessidade de investigação sorológica do paciente-fonte quando a fonte é desconhecida.", "o descarte de perfurocortantes pode ser feito em saco branco leitoso identificado como infectante."],
  correta: 2,
  ...
  alts: ["resíduos do Grupo A (biológicos/infectantes) devem ser descartados em saco branco leitoso.", "peças anatômicas e bolsas de sangue vencidas pertencem ao Grupo D (resíduos comuns).", "medicamentos vencidos e resíduos químicos perigosos pertencem ao Grupo A.", "agulhas, lâminas e ampolas de vidro pertencem ao Grupo A e vão em saco vermelho.", "resíduos comuns, como papel de escritório, pertencem ao Grupo E e vão em caixa rígida."],
  correta: 0,
  ...
  alts: ["a temperatura ideal de conservação dos imunobiológicos na instância local é de 0 °C a +4 °C.", "os imunobiológicos devem ser conservados entre +2 °C e +8 °C na sala de vacinação.", "as vacinas podem ser mantidas na porta do refrigerador para facilitar o acesso da equipe.", "o descongelamento acidental de vacinas de vírus atenuado não compromete sua eficácia.", "a leitura da temperatura do refrigerador deve ser feita e registrada apenas uma vez ao dia."],
  correta: 1,
  ...
  alts: ["artigos semicríticos, que entram em contato com pele íntegra, exigem apenas limpeza.", "artigos críticos, que penetram tecidos estéreis ou o sistema vascular, exigem esterilização.", "artigos não críticos, que tocam mucosas íntegras, exigem desinfecção de alto nível.", "um endoscópio digestivo é classificado como artigo crítico e deve ser esterilizado por vapor.", "a classificação de Spaulding baseia-se no material de composição do artigo, não em seu uso."],
  correta: 1,
...
// ═══════════ AUTORAIS: ADMINISTRAÇÃO ═══════════
{
  ...
  alts: ["o dimensionamento independe do Sistema de Classificação de Pacientes (SCP), bastando o número de leitos.", "para cuidados intensivos, considera-se a proporção de 17,9 horas de enfermagem por leito nas 24 horas.", "a distribuição percentual de profissionais é fixa em 50% enfermeiros e 50% técnicos em qualquer unidade.", "o Índice de Segurança Técnica (IST) recomendado não deve ser inferior a 15%.", "as horas de assistência para cuidado mínimo são superiores às de cuidado semi-intensivo."],
  correta: 3,
  ...
  alts: ["Classifica os pacientes segundo o grau de dependência da equipe de enfermagem em relação ao cuidado.", "É aplicado uma única vez, na admissão, e não se altera durante a internação.", "Serve apenas para fins estatísticos, sem relação com a alocação de profissionais.", "Substitui a avaliação clínica individual do paciente pela equipe de enfermagem.", "É de responsabilidade exclusiva do médico assistente da unidade."],
  correta: 0,
  ...
  alts: ["liderança autocrática, centralizadora das decisões.", "liderança laissez-faire, com ausência de direcionamento.", "liderança situacional, que varia conforme o contexto e o grupo.", "liderança liberal, em que a equipe decide sem interferência.", "liderança carismática, baseada apenas em traços de personalidade."],
  correta: 2,
  ...
  alts: ["a Administração Científica de Taylor à ênfase nas relações humanas e na motivação do trabalhador.", "a Teoria Clássica de Fayol às funções administrativas de planejar, organizar, dirigir e controlar.", "a Teoria das Relações Humanas de Mayo ao estudo de tempos e movimentos na linha de produção.", "a Teoria Burocrática de Weber à informalidade e à ausência de normas escritas.", "a Teoria de Sistemas ao foco exclusivo no ambiente interno da organização."],
  correta: 1,
  ...
  alts: ["estrutura, pois avalia os recursos físicos e materiais disponíveis.", "processo, pois mede como o cuidado foi executado.", "resultado, pois reflete o efeito da assistência sobre o paciente.", "estrutura, pois depende do número de profissionais da unidade.", "processo, pois avalia a adesão a protocolos de prevenção."],
  correta: 2,
  ...
  id: "aut-admin-06",
  eixo: "admin",
  sub: "Gestão de pessoas e escalas",
  banca: "Autoral Resifriends",
  estilo: "FGV",
  ano: 2026,
  autoral: true,
  ...
  alts: ["a escala diária substitui a escala mensal e dispensa o planejamento antecipado.", "a escala de férias deve ser elaborada de modo a não comprometer a cobertura assistencial da unidade.", "a distribuição de folgas pode desconsiderar a legislação trabalhista, a critério da chefia.", "a escala de horário é de responsabilidade do setor de recursos humanos, não da enfermagem.", "o remanejamento de pessoal entre unidades é vedado em qualquer circunstância."],
  correta: 1,
  ...
  alts: ["Deve ser usada exclusivamente como instrumento punitivo diante de erros.", "É um processo contínuo que visa ao desenvolvimento profissional e à melhoria da assistência.", "Deve basear-se apenas na percepção pessoal do avaliador, sem critérios definidos.", "Dispensa qualquer retorno (feedback) ao profissional avaliado.", "Aplica-se somente a profissionais recém-admitidos em período de experiência."],
  correta: 1,
  ...
  alts: ["funcional, centrado na divisão de tarefas por procedimento.", "integral (ou de cuidado integral/primary nursing), centrado no paciente.", "de casos por tarefa, em que cada técnico executa um procedimento único.", "em cadeia, com fragmentação máxima do cuidado.", "por produção, focado no número de procedimentos realizados."],
  correta: 1,
  ...
  alts: ["P (Plan) corresponde à execução das ações planejadas.", "D (Do) corresponde ao planejamento e à definição de metas.", "C (Check) corresponde à verificação e à avaliação dos resultados obtidos.", "A (Act) corresponde exclusivamente ao registro documental do processo.", "o ciclo é linear e se encerra após a primeira aplicação, sem repetição."],
  correta: 2,
...
// ═══════════ AUTORAIS: ASSISTÊNCIA POR SISTEMAS ═══════════
{
  ...
  alts: ["aguardar a estabilização espontânea antes de qualquer conduta, evitando manipulação.", "acionar o protocolo de AVC e priorizar a realização de neuroimagem, pois o tempo é determinante.", "administrar anti-hipertensivo imediatamente para normalizar a pressão a qualquer custo.", "posicionar o paciente em Trendelenburg para aumentar a perfusão cerebral.", "oferecer dieta via oral precocemente para prevenir hipoglicemia."],
  correta: 1,
  ...
  alts: ["quanto maior o fluxo de oxigênio, melhor, devendo-se ofertar sempre a 100%.", "no retentor crônico de CO2, a oxigenoterapia deve ser controlada e titulada por alvos de saturação.", "a oxigenoterapia é contraindicada na DPOC por agravar sempre a insuficiência respiratória.", "a saturação-alvo ideal para todo paciente com DPOC é manter SpO2 acima de 99%.", "o uso de máscara de Venturi impede o controle preciso da fração de oxigênio ofertada."],
  correta: 1,
  ...
  alts: ["liberar o paciente para deambular a fim de avaliar a tolerância ao esforço.", "realizar ECG de 12 derivações o mais rápido possível e manter monitorização.", "aguardar o resultado dos marcadores de necrose antes de qualquer intervenção.", "administrar dieta hipercalórica para reposição energética imediata.", "posicionar o paciente em decúbito ventral para alívio da dor."],
  correta: 1,
  ...
  alts: ["deve-se aferir a pressão arterial e puncionar veias preferencialmente no membro da fístula.", "a presença de frêmito (thrill) à palpação indica obstrução e deve ser comunicada como emergência.", "o membro da fístula deve ser protegido: sem punções, sem aferição de PA e sem garrote nesse braço.", "a fístula pode ser utilizada para infusão de soro e medicações de rotina, além da diálise.", "recomenda-se manter o membro da fístula imóvel e elevado permanentemente para evitar trombose."],
  correta: 2,
  ...
  alts: ["oferta de dieta hiperproteica para recuperar a massa muscular perdida.", "monitorização neurológica e atenção ao uso de lactulose para reduzir a amônia intestinal.", "restrição hídrica absoluta e suspensão de toda medicação via oral.", "estímulo à deambulação intensa para melhorar o nível de consciência.", "administração de sedativos para controlar a agitação do paciente."],
  correta: 1,
  ...
  id: "aut-sist-06",
  eixo: "sistemas",
  sub: "Sistema músculo-esquelético",
  banca: "Autoral Resifriends",
  estilo: "AOCP",
  ano: 2026,
  autoral: true,
  ...
  alts: ["massagear vigorosamente a panturrilha para melhorar o retorno venoso.", "comunicar imediatamente, manter repouso e evitar manipular/massagear o membro afetado.", "estimular exercícios ativos intensos do membro para dispersar o coágulo.", "aplicar calor local intenso e realizar deambulação forçada.", "elevar a cabeceira a 90° e restringir totalmente a hidratação."],
  correta: 1,
  ...
  alts: ["administrar insulina rápida adicional para corrigir a suposta hiperglicemia.", "oferecer carboidrato de absorção rápida por via oral e reavaliar a glicemia.", "manter o paciente em jejum absoluto até a próxima refeição programada.", "oferecer alimentos ricos em gordura e proteína para saciedade prolongada.", "restringir líquidos e aguardar a resolução espontânea dos sintomas."],
  correta: 1,
  ...
  alts: ["manter o paciente em decúbito dorsal horizontal (0°) para reduzir o esforço cardíaco.", "controlar o balanço hídrico, restringir sódio e manter cabeceira elevada (posição de Fowler).", "liberar a ingestão de líquidos e sódio à vontade para evitar desidratação.", "suspender o controle diário de peso, por ser irrelevante na ICC.", "estimular grandes esforços físicos para fortalecer o miocárdio na fase aguda."],
  correta: 1,
  ...
  alts: ["o frasco coletor deve ser mantido sempre acima do nível do tórax do paciente.", "o borbulhamento contínuo e intenso no selo d'água é sempre sinal esperado e normal.", "em caso de desconexão acidental do dreno, o frasco deve ser mantido abaixo do tórax e o sistema, hermético.", "clampar o dreno rotineiramente durante o transporte é a conduta padrão recomendada.", "a oscilação da coluna líquida com a respiração indica obstrução do sistema."],
  correta: 2,
...
// ═══════════ AUTORAIS: SEMIOLOGIA E SAE ═══════════
{
  ...
  alts: ["três etapas: coleta de dados, diagnóstico e evolução.", "cinco etapas inter-relacionadas, iniciando pela avaliação/coleta de dados e culminando na avaliação de enfermagem.", "duas etapas apenas: prescrição e evolução de enfermagem.", "seis etapas independentes, executadas sem qualquer inter-relação.", "quatro etapas, excluindo-se o diagnóstico de enfermagem do processo."],
  correta: 1,
  ...
  alts: ["são exatamente sinônimos e podem ser usados de forma intercambiável sem distinção.", "o Processo de Enfermagem é o método/instrumento que operacionaliza o cuidado em etapas.", "a SAE substitui completamente o raciocínio clínico do enfermeiro.", "o Processo de Enfermagem aplica-se apenas em unidades de terapia intensiva.", "o diagnóstico de enfermagem é etapa exclusiva do técnico de enfermagem."],
  correta: 1,
  ...
  alts: ["Prescrição, Evolução e Sinais vitais.", "Problema (título), Etiologia (fatores relacionados) e Sinais e sintomas (características definidoras).", "Prognóstico, Exame físico e Semiologia.", "Planejamento, Execução e Supervisão.", "Paciente, Enfermeiro e Serviço."],
  correta: 1,
  ...
  alts: ["inspeção, palpação, percussão e ausculta, como em qualquer segmento.", "inspeção, ausculta, percussão e palpação, para não alterar os ruídos hidroaéreos.", "palpação, inspeção, ausculta e percussão.", "percussão, palpação, ausculta e inspeção.", "ausculta, inspeção, palpação e percussão."],
  correta: 1,
  ...
  alts: ["ao conjunto de todas as doenças pregressas relatadas pelo paciente.", "ao motivo que levou o paciente a procurar o serviço, preferencialmente em suas próprias palavras.", "ao histórico familiar de doenças hereditárias.", "à lista de medicamentos em uso contínuo pelo paciente.", "aos dados de identificação, como nome, idade e procedência."],
  correta: 1,
  ...
  alts: ["bradicardia, bradipneia e hipertensão.", "taquicardia, taquipneia e febre.", "frequência cardíaca e respiratória dentro dos parâmetros normais.", "hipotermia e bradicardia.", "eupneia e normocardia com hipertermia isolada."],
  correta: 1,
  ...
  alts: ["o diagnóstico e a prescrição de enfermagem podem ser realizados por qualquer membro da equipe.", "a coleta de dados, o diagnóstico e a prescrição de enfermagem são privativos do enfermeiro.", "a implementação dos cuidados é atividade exclusiva do enfermeiro, vedada aos técnicos.", "o técnico de enfermagem é responsável por elaborar o plano de cuidados e os diagnósticos.", "a evolução de enfermagem é atribuição exclusiva do médico da unidade."],
  correta: 1,
  ...
  alts: ["trata-se de hipocalemia, sem repercussão clínica relevante.", "trata-se de hipercalemia, condição que exige atenção pelo risco de arritmias cardíacas graves.", "o valor está dentro da faixa de normalidade e não requer conduta.", "trata-se de hiponatremia, devendo-se repor sódio imediatamente.", "trata-se de hipercalcemia, sem relação com o ritmo cardíaco."],
  correta: 1,
  ...
  alts: ["as intervenções devem ser genéricas, sem individualização para o paciente.", "os resultados esperados (metas) devem ser mensuráveis e definir prioridades de cuidado.", "o planejamento independe dos diagnósticos identificados na etapa anterior.", "a prescrição de enfermagem não precisa ser registrada no prontuário.", "as prioridades são definidas aleatoriamente, sem hierarquização das necessidades."],
  correta: 1,
  ...
  alts: ["azul, correspondente a casos não urgentes.", "vermelha, correspondente à emergência, com atendimento imediato.", "verde, correspondente a atendimento em até 120 minutos.", "amarela, correspondente a atendimento imediato.", "branca, correspondente à prioridade máxima."],
  correta: 1,
  ...
  alts: ["avalia três parâmetros: abertura ocular, resposta verbal e resposta motora, com escore de 3 a 15.", "o menor escore possível é 0, indicando paciente desperto e orientado.", "avalia exclusivamente o diâmetro e a reatividade pupilar.", "um escore de 15 indica coma profundo e ausência de resposta.", "a melhor resposta motora possível é a resposta em flexão anormal (decorticação)."],
  correta: 0,
...
// ═══════════ AUTORAIS: BIOÉTICA E LEGISLAÇÃO ═══════════
{
  ...
  alts: ["a prestação de cuidados de enfermagem a pacientes graves com risco de vida.", "a execução de cuidados de higiene e conforto de menor complexidade.", "a participação em programas de higiene e segurança do trabalho.", "a participação na orientação e supervisão do trabalho de enfermagem em grau auxiliar.", "a coleta rotineira de material para exames laboratoriais."],
  correta: 0,
  ...
  alts: ["beneficência.", "não maleficência.", "autonomia.", "justiça.", "vulnerabilidade."],
  correta: 2,
  ...
  alts: ["o sigilo pode ser quebrado livremente sempre que o profissional julgar conveniente.", "o profissional deve manter segredo sobre fato sigiloso de que tenha conhecimento em razão da atividade, salvo casos previstos em lei ou por justa causa.", "o dever de sigilo cessa imediatamente após a alta do paciente.", "o sigilo não se aplica a informações registradas no prontuário.", "o sigilo é dispensável quando o paciente é menor de idade."],
  correta: 1,
  ...
  alts: ["dispensa a prestação de informações ao paciente quando o procedimento é de rotina.", "é a manifestação de vontade do paciente após receber informações claras sobre o procedimento, seus riscos e alternativas.", "uma vez assinado, impede o paciente de desistir ou revogar sua decisão.", "pode ser obtido de qualquer acompanhante, independentemente da vontade do paciente capaz.", "é exigível apenas em pesquisas, não na assistência clínica."],
  correta: 1,
  ...
  alts: ["prisão administrativa do profissional infrator.", "advertência verbal, multa, censura, suspensão do exercício profissional e cassação do direito ao exercício profissional.", "apreensão dos bens pessoais do profissional.", "obrigação de prestar serviço comunitário compulsório.", "deportação do profissional para outro estado."],
  correta: 1,
  ...
  alts: ["eutanásia.", "distanásia.", "ortotanásia.", "mistanásia.", "iatrogenia."],
  correta: 2,
  ...
  alts: ["recusar-se a exercer atividades que não sejam de sua competência técnica, científica, ética e legal.", "abandonar o plantão sem comunicação, desde que por motivo pessoal.", "delegar aos acompanhantes a execução de cuidados de enfermagem de alta complexidade.", "prestar assistência sem qualquer registro no prontuário para agilizar o serviço.", "recusar atendimento a paciente por motivo de raça, credo ou condição social."],
  correta: 0,
  ...
  alts: ["ignorar a recusa e transfundir imediatamente, pois a vida se sobrepõe a tudo.", "reconhecer a complexidade do conflito ético, respeitando a autonomia do paciente capaz e buscando alternativas terapêuticas e diálogo com a equipe.", "abandonar o cuidado do paciente por discordar de sua decisão.", "coagir o paciente a mudar de opinião usando informações amedrontadoras.", "solicitar que o paciente assine termo isentando o profissional e negar qualquer outro cuidado."],
  correta: 1,
  ...
  alts: ["exclusivamente penal, com pena privativa de liberdade.", "civil, relacionada à reparação/indenização do dano causado.", "apenas ética, restrita ao âmbito do Conselho profissional.", "administrativa, restrita à relação de emprego.", "inexistente, pois o profissional nunca responde por danos."],
  correta: 1,
  ...
  alts: ["negligência.", "imprudência.", "imperícia.", "dolo.", "caso fortuito."],
  correta: 2,
  ...
  alts: ["o COFEN e os CORENs são sindicatos responsáveis por negociar salários da categoria.", "compete aos Conselhos a fiscalização do exercício profissional e o julgamento ético-disciplinar.", "o registro profissional no COREN é facultativo para o exercício da enfermagem.", "os CORENs são responsáveis pela formação e diplomação dos profissionais.", "o COFEN atua apenas em âmbito municipal, sem abrangência nacional."],
  correta: 1,
  ...
  alts: ["autonomia.", "beneficência.", "justiça.", "não maleficência.", "confidencialidade."],
  correta: 2,
  ...
  alts: ["o técnico e o auxiliar de enfermagem exercem suas atividades com total autonomia, sem supervisão do enfermeiro.", "as atividades do técnico e do auxiliar de enfermagem são exercidas sob supervisão e orientação do enfermeiro.", "o enfermeiro pode delegar a prescrição de enfermagem ao técnico em unidades de menor porte.", "o auxiliar de enfermagem pode assumir a chefia do serviço de enfermagem na ausência do enfermeiro.", "a consulta de enfermagem pode ser realizada pelo técnico devidamente inscrito no COREN."],
  correta: 1,
  ...
  alts: ["aplica-se apenas aos enfermeiros, excluindo técnicos e auxiliares de enfermagem.", "estabelece direitos, deveres, proibições e responsabilidades dos profissionais de enfermagem.", "tem caráter meramente sugestivo, sem gerar sanções em caso de descumprimento.", "sobrepõe-se à legislação penal e civil em qualquer circunstância.", "aplica-se somente ao serviço público, não ao setor privado."],
  correta: 1,
  ...
  alts: ["rasuras e o uso de corretivo são permitidos para manter a estética do documento.", "as anotações devem ser claras, legíveis, completas, datadas, assinadas e identificadas com o registro profissional (COREN).", "o registro é dispensável quando o cuidado é considerado de rotina.", "é permitido registrar cuidados que não foram efetivamente realizados, para completar o prontuário.", "as anotações podem ser feitas a lápis para facilitar eventuais correções."],
  correta: 1,
...
// ═══════════ AUTORAIS: CICLOS DE VIDA ═══════════
{
  ...
  alts: ["exclusivo é recomendado até os 4 meses de idade, com introdução de água a partir de então.", "exclusivo é recomendado até os 6 meses e o complementado, até os 2 anos ou mais.", "deve ser complementado com chás e água desde o primeiro mês para hidratação.", "exclusivo deve ser mantido até os 2 anos, sem introdução de outros alimentos.", "é contraindicado nas primeiras 24 horas de vida do recém-nascido."],
  correta: 1,
  ...
  alts: ["tríplice viral e febre amarela.", "BCG e hepatite B.", "pentavalente e VIP (poliomielite inativada).", "rotavírus e pneumocócica 10-valente.", "meningocócica C e tríplice bacteriana (DTP)."],
  correta: 1,
  ...
  alts: ["o número mínimo de consultas de pré-natal recomendado é de uma consulta ao longo da gestação.", "recomenda-se o mínimo de 6 consultas, com início precoce no primeiro trimestre.", "o pré-natal deve iniciar apenas no terceiro trimestre da gestação.", "a enfermeira não pode realizar consultas de pré-natal de baixo risco.", "a aferição da pressão arterial é dispensável nas consultas de pré-natal."],
  correta: 1,
  ...
  alts: ["uma condição normal e inevitável do envelhecimento, sem possibilidade de intervenção.", "uma síndrome de vulnerabilidade fisiológica com redução da reserva funcional e maior risco de desfechos adversos.", "sinônimo exclusivo de idade cronológica avançada, independentemente do estado de saúde.", "a presença isolada de uma única doença crônica no idoso.", "uma condição exclusivamente psicológica, sem componente físico."],
  correta: 1,
  ...
  alts: ["para todas as mulheres a partir da primeira menstruação, anualmente por toda a vida.", "para mulheres de 25 a 64 anos que já tiveram atividade sexual, a cada 3 anos após dois exames anuais normais.", "apenas para mulheres acima de 65 anos, independentemente do histórico.", "somente para mulheres com sintomas de sangramento vaginal.", "uma única vez na vida, sem necessidade de repetição."],
  correta: 1,
  ...
  alts: ["uma única medida de peso é suficiente para avaliar o crescimento, dispensando o acompanhamento.", "o traçado da curva ao longo do tempo (tendência) é mais importante do que um ponto isolado.", "o desvio da curva para baixo é sempre esperado e não requer investigação.", "o perímetro cefálico não tem relevância no acompanhamento do lactente.", "a caderneta destina-se apenas ao registro de vacinas, não do crescimento."],
  correta: 1,
  ...
  alts: ["o preservativo (masculino ou feminino) é o único método que também previne infecções sexualmente transmissíveis.", "os métodos hormonais orais protegem contra as infecções sexualmente transmissíveis.", "a laqueadura e a vasectomia são métodos reversíveis de curto prazo.", "o planejamento familiar deve ser imposto pelo profissional, sem escolha do casal.", "o dispositivo intrauterino (DIU) é contraindicado para todas as mulheres que ainda não tiveram filhos."],
  correta: 0,
  ...
  alts: ["orientar repouso domiciliar e reagendar retorno para dali a 30 dias, sem outras medidas.", "reconhecer o sinal de gravidade, comunicar imediatamente e encaminhar para avaliação, monitorizando PA e sinais de iminência de eclâmpsia.", "liberar a gestante com orientação de aumentar a ingestão de sal.", "considerar a pressão normal para a idade gestacional e não intervir.", "administrar diurético por conta própria para reduzir o edema."],
  correta: 1,
  ...
  alts: ["restringir o cuidado apenas à consulta médica, sem participação da enfermagem.", "realizar consulta de enfermagem, educação em saúde, estratificação de risco e apoio ao autocuidado.", "orientar o abandono das mudanças no estilo de vida em favor exclusivo de medicamentos.", "desencorajar a adesão ao tratamento para reduzir a demanda no serviço.", "limitar-se a aferir a pressão arterial, sem qualquer orientação ao paciente."],
  correta: 1,
  ...
  alts: ["o adolescente jamais pode ser atendido sem a presença dos pais ou responsáveis.", "o adolescente tem direito à privacidade e ao sigilo no atendimento, com exceções em situações de risco à vida.", "toda informação do adolescente deve ser obrigatoriamente repassada aos pais em qualquer situação.", "o adolescente não tem direito a receber orientação sobre métodos contraceptivos.", "a confidencialidade é vedada no atendimento a menores de 18 anos em qualquer circunstância."],
  correta: 1,
  ...
  alts: ["o útero deve permanecer no nível da cicatriz umbilical por todo o puerpério, sem involução.", "espera-se a involução uterina progressiva e a evolução dos lóquios de rubros para serosos e depois alba.", "os lóquios com odor fétido e febre são achados normais e esperados no puerpério.", "a involução uterina não precisa ser avaliada pela enfermagem.", "a presença de lóquios vermelho-vivos abundantes com coágulos após semanas é sinal de recuperação ideal."],
  correta: 1,
  ...
  alts: ["deve ser realizado idealmente entre o 3º e o 5º dia de vida do recém-nascido.", "deve ser coletado obrigatoriamente na primeira hora de vida, ainda na sala de parto.", "destina-se exclusivamente ao diagnóstico de cardiopatias congênitas.", "só deve ser realizado se a criança apresentar sintomas de alguma doença.", "pode ser feito a qualquer momento até o primeiro ano de vida, sem prejuízo."],
  correta: 0,
  ...
  alts: ["as quedas em idosos têm causa única e são sempre inevitáveis.", "fatores intrínsecos (como alterações de equilíbrio e polifarmácia) e extrínsecos (ambientais) contribuem, e ambos são passíveis de intervenção.", "a revisão de medicamentos não influencia o risco de quedas no idoso.", "a atividade física deve ser desencorajada no idoso para evitar quedas.", "tapetes soltos e má iluminação não têm relação com o risco de quedas."],
  correta: 1,
  ...
  alts: ["em qualquer situação, a pedido da gestante, sem restrições legais.", "resultante de estupro, risco de vida para a gestante e feto anencéfalo (este por decisão do STF).", "apenas quando há risco de vida para o feto, e não para a gestante.", "somente mediante autorização judicial prévia em todos os casos, inclusive risco de vida.", "em nenhuma hipótese, sendo o aborto sempre criminalizado no Brasil."],
  correta: 1,
  ...
  alts: ["o manguito deve ter largura equivalente a cerca de 40% da circunferência do braço e ser posicionado adequadamente.", "o paciente pode estar com as pernas cruzadas e a bexiga cheia sem interferência no resultado.", "a medida deve ser feita logo após esforço físico intenso para obter valor mais fidedigno.", "o braço deve permanecer pendente, abaixo do nível do coração, durante a aferição.", "recomenda-se conversar com o paciente durante a medida para mantê-lo relaxado."],
  correta: 0,
...
// ═══════════ AUTORAIS: EPIDEMIOLOGIA E EDUCAÇÃO EM SAÚDE ═══════════
{
  ...
  alts: ["Endemia é a ocorrência de uma doença em vários países ou continentes simultaneamente.", "Epidemia é a ocorrência de casos de uma doença em número claramente superior ao esperado para uma região e período.", "Pandemia é a ocorrência habitual e esperada de uma doença em determinada área geográfica.", "Endemia refere-se ao surgimento súbito e inesperado de uma nova doença.", "Surto e pandemia são termos idênticos e intercambiáveis."],
  correta: 1,
  ...
  alts: ["coeficiente de mortalidade materna.", "coeficiente (taxa) de mortalidade infantil.", "coeficiente de mortalidade geral.", "coeficiente de letalidade.", "coeficiente de prevalência."],
  correta: 1,
  ...
  alts: ["a incidência mede o total de casos existentes em um dado momento.", "a incidência mede os casos NOVOS de uma doença em um período; a prevalência, os casos existentes.", "prevalência e incidência são sinônimos e medem a mesma coisa.", "a prevalência mede apenas os óbitos por uma doença.", "a incidência só se aplica a doenças crônicas de longa duração."],
  correta: 1,
  ...
  alts: ["primária, voltada à promoção da saúde e à proteção específica.", "secundária, voltada ao diagnóstico precoce.", "terciária, voltada à reabilitação.", "quaternária, voltada a evitar iatrogenia.", "nenhuma, pois a vacinação não é considerada ação preventiva."],
  correta: 0,
  ...
  id: "aut-bonus-05",
  eixo: "bonus",
  sub: "Indicadores de saúde coletiva",
  banca: "Autoral Resifriends",
  estilo: "FGV",
  ano: 2026,
  autoral: true,
  ...
  alts: ["a notificação compulsória é facultativa e depende exclusivamente da vontade do profissional.", "a notificação de doenças de notificação compulsória é obrigatória e deve seguir os prazos estabelecidos, alimentando o SINAN.", "apenas o médico pode notificar; os demais profissionais estão dispensados.", "doenças de notificação imediata podem ser comunicadas em até 30 dias.", "a notificação só é exigida após a confirmação laboratorial do caso."],
  correta: 1,
  ...
  alts: ["o reservatório é o indivíduo ou animal sadio que nunca abriga o agente.", "a porta de saída, o modo de transmissão e a porta de entrada são elos da cadeia de transmissão.", "o agente etiológico é sempre uma bactéria, nunca vírus ou fungo.", "o hospedeiro suscetível é aquele totalmente imune ao agente.", "a interrupção de um único elo jamais impede a transmissão da doença."],
  correta: 1,
  ...
  alts: ["baseia-se na transmissão vertical de conhecimento, do profissional 'que sabe' para o usuário 'que não sabe'.", "valoriza o saber prévio do usuário e constrói o conhecimento de forma dialógica e participativa.", "considera o usuário um receptor passivo, sem contribuição ao processo.", "dispensa a escuta da comunidade, priorizando apenas as normas técnicas.", "deve impor mudanças de comportamento sem considerar o contexto sociocultural."],
  correta: 1,
  ...
  alts: ["O SINASC registra os óbitos ocorridos no país.", "O SIM (Sistema de Informações sobre Mortalidade) registra os dados de óbitos.", "O SINAN registra exclusivamente os nascidos vivos.", "O SINASC (Sistema de Informações sobre Nascidos Vivos) registra os agravos de notificação.", "Nenhum sistema de informação é utilizado na vigilância em saúde."],
  correta: 1,
  ...
  alts: ["as precauções-padrão aplicam-se apenas a pacientes com diagnóstico infeccioso confirmado.", "as precauções-padrão devem ser aplicadas a TODOS os pacientes, independentemente do diagnóstico.", "a precaução para aerossóis dispensa o uso de máscara pelo profissional.", "a precaução de contato dispensa a higiene das mãos.", "não há diferença entre precauções por gotículas e por aerossóis."],
  correta: 1,
  ...
  alts: ["universalidade.", "hierarquização.", "descentralização.", "regionalização.", "resolutividade."],
  correta: 0,
  ...
  alts: ["significa oferecer exatamente o mesmo atendimento a todos, sem distinção de necessidades.", "significa tratar de forma desigual os desiguais, investindo mais recursos onde há maior necessidade, para reduzir iniquidades.", "é sinônimo perfeito de universalidade, sem qualquer diferença conceitual.", "restringe o acesso à saúde apenas às pessoas que contribuem financeiramente.", "prioriza sempre quem chega primeiro, por ordem de chegada, sem avaliar a gravidade."],
  correta: 1,
  ...
  alts: ["atua de forma centrada exclusivamente na doença e no atendimento hospitalar.", "trabalha com território definido, população adscrita e enfoque na promoção da saúde e prevenção, com equipe multiprofissional.", "dispensa a figura do agente comunitário de saúde na composição da equipe.", "restringe as ações ao consultório, sem visitas domiciliares.", "o enfermeiro não integra a equipe mínima da Estratégia Saúde da Família."],
  correta: 1,
  ...
  alts: ["os Conselhos de Saúde têm caráter apenas consultivo, sem poder deliberativo.", "os Conselhos de Saúde são permanentes e deliberativos, com participação paritária dos usuários em relação ao conjunto dos demais segmentos.", "a participação da comunidade na gestão do SUS não é prevista em lei.", "as Conferências de Saúde ocorrem mensalmente para fiscalizar contas.", "apenas gestores e profissionais de saúde podem compor os Conselhos de Saúde."],
  correta: 1,
  ...
  alts: ["epidemiológica.", "ambiental (em saúde ambiental).", "sanitária.", "da situação de saúde do trabalhador, apenas.", "laboratorial, exclusivamente."],
  correta: 1,
  ...
  alts: ["consiste em uma palestra expositiva longa, sem espaço para dúvidas ou troca.", "parte das necessidades e do contexto do grupo, estimula a participação e utiliza linguagem acessível.", "deve utilizar linguagem técnica complexa para demonstrar autoridade do profissional.", "ignora as experiências prévias das gestantes por serem irrelevantes.", "tem como único objetivo o cumprimento de metas quantitativas do serviço."],
  correta: 1,
...
const MATERIAL_CURSO = [{
  arq: "Resifriends_Manual_do_Aluno.pdf",
...
const AULAS_GRAVADAS = [{
  id: "a1",
  eixo: "Ética",
  titulo: "Lei 7.498/86 — atribuições privativas",
  dur: "48 min",
  videoId: "dQw4w9WgXcQ",
  data: "05/07"
}, {
  id: "a2",
  eixo: "Segurança",
  titulo: "As 6 metas internacionais de segurança",
  dur: "52 min",
  videoId: "dQw4w9WgXcQ",
  data: "08/07"
}, {
  id: "a3",
  eixo: "Imunização",
  titulo: "Calendário do PNI e rede de frio",
  dur: "45 min",
  videoId: "dQw4w9WgXcQ",
  data: "12/07"
}];
...
async function sSet(key, val) {
  ...
  if (db) {
    try {
      await db.collection(CHAVE_COLECAO).doc(key).set({
        valor: val,
...
function horasPeriodo(diario, dias = 7) {
  ...
  return Object.entries(diario || {}).filter(([d]) => new Date(d) >= limite).reduce((a, [, h]) => a + Number(h || 0), 0);
}
...
const btnOuro = {
  background: `linear-gradient(135deg, ${C.dourado}, ${C.marromClaro})`,
  color: C.preto,
  border: "none",
  borderRadius: 9,
  padding: "12px 22px",
...
function App() {
  ...
  const recarregar = useCallback(async () => {
    ...
    for (const t of TURMA_2026) {
      if (!lista.some(a => a.codigo === t.codigo)) {
        ...
        lista = lista.map(a => a.codigo === t.codigo ? {
          ...a,
          senha: a.senha || t.senha
        } : a);
      }
    }
  ...
  if (carregando) return /*#__PURE__*/React.createElement(TelaCarregando, null);
  if (!sessao) return /*#__PURE__*/React.createElement(TelaLogin, {
    alunos: alunos,
    onEntrar: setSessao,
    onRecarregar: recarregar
  });
  if (sessao.tipo === "prof") return /*#__PURE__*/React.createElement(PainelProfessor, {
    alunos: alunos,
    onSair: () => setSessao(null),
    onRecarregar: recarregar
  });
  return /*#__PURE__*/React.createElement(PortalAluno, {
    aluno: sessao.aluno,
    onSair: () => setSessao(null),
    onRecarregar: recarregar
  });
...
function TelaLogin({
  ...
  async function entrarAluno() {
    setErro("");
    if (!codigoSel) {
      setErro("Escolha o seu nome na lista.");
      return;
    }
    if (!senha.trim()) {
    ...
    if (!a) {
      setErro("Aluna não encontrada. Fale com a professora.");
      return;
    }
    if ((a.senha || "").trim() !== senha.trim()) {
      setErro("Senha incorreta. Confira com a professora.");
      return;
    }
    onEntrar({
      tipo: "aluno",
  ...
  function entrarProf() {
    setErro("");
    if (codigo.trim().toUpperCase() !== SENHA_PROFESSORA) {
      setErro("Senha da professora incorreta.");
      return;
    }
    onEntrar({
      tipo: "prof"
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      height: 6,
      background: `linear-gradient(90deg, ${C.dourado}, ${C.marrom})`
    }
  }), /*#__PURE__*/React.createElement("div", {
    style: {
      flex: 1,
  ...
  }, "Missão Aprovação")), /*#__PURE__*/React.createElement("div", {
    style: card
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
  ...
  }, [["aluno", "Sou aluno"], ["prof", "Sou professora"]].map(([k, v]) => /*#__PURE__*/React.createElement("button", {
    key: k,
    onClick: () => {
      setModo(k);
      setErro("");
    ...
    style: {
      flex: 1,
      background: modo === k ? C.dourado : "transparent",
      color: modo === k ? C.preto : C.cinza,
      border: `1px solid ${modo === k ? C.dourado : "#5a3d26"}`,
      borderRadius: 8,
      padding: "9px",
      fontSize: 13,
      fontWeight: 700,
  ...
  }, v))), modo === "aluno" ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("label", {
    style: {
      fontSize: 12,
      color: C.cinza,
      letterSpacing: ".05em",
  ...
  }, "SEU NOME"), /*#__PURE__*/React.createElement("select", {
    style: {
      ...inputStyle,
      marginBottom: 14,
      cursor: "pointer"
    ...
    value: codigoSel,
    onChange: e => {
      setCodigoSel(e.target.value);
      setErro("");
    }
  }, /*#__PURE__*/React.createElement("option", {
    value: ""
  }, "Selecione o seu nome…"), [...alunos].sort((a, b) => a.nome.localeCompare(b.nome)).map(a => /*#__PURE__*/React.createElement("option", {
    key: a.codigo,
    value: a.codigo
  }, a.nome))), /*#__PURE__*/React.createElement("label", {
    style: {
      fontSize: 12,
      color: C.cinza,
      letterSpacing: ".05em",
  ...
  }, "SUA SENHA"), /*#__PURE__*/React.createElement("input", {
    type: "password",
    style: {
      ...inputStyle,
      marginBottom: 14
    ...
    onClick: entrarAluno
  }, "Entrar na minha área"), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 12,
      color: C.cinza,
      textAlign: "center",
  ...
  }, "Escolha o seu nome e digite a senha que a professora te enviou.", /*#__PURE__*/React.createElement("br", null), "Esqueceu a senha? Fale com a coordenação.")) : /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("label", {
    style: {
      fontSize: 12,
      color: C.cinza,
      letterSpacing: ".05em",
  ...
  }, "SENHA DA PROFESSORA"), /*#__PURE__*/React.createElement("input", {
    type: "password",
    style: {
      ...inputStyle,
      marginBottom: 14
    ...
    onKeyDown: e => e.key === "Enter" && entrarProf()
  }), /*#__PURE__*/React.createElement("button", {
    style: {
      ...btnOuro,
      width: "100%"
    ...
    onClick: entrarProf
  }, "Acessar painel")), erro && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 14,
      padding: "10px 12px",
      background: "#321413",
  ...
  }, "Planeje. Estude. Execute. Alcance."))));
}
...
function PainelProfessor({
  ...
  const carregarProgressos = useCallback(async () => {
    const obj = {};
    for (const a of alunos) obj[a.codigo] = (await sGet(`prog_${a.codigo}`)) || {
      respostas: {},
      aulasFeitas: {},
      diario: {},
      atividade: {}
  ...
  async function cadastrar() {
    setMsg("");
    if (!nome.trim() || !codigo.trim() || !senhaNova.trim()) {
      setMsg("Preencha nome, código e senha.");
      return;
    }
    const cod = codigo.trim().toUpperCase();
    if (alunos.some(a => a.codigo.toUpperCase() === cod)) {
      setMsg("Já existe aluna com esse código.");
      return;
    }
    if (alunos.length >= 15) {
      setMsg("Turma cheia (teto de 15).");
      return;
    }
    const novo = {
      nome: nome.trim(),
    ...
    setCodigo("");
    setSenhaNova("");
    setMsg(`✓ ${novo.nome} cadastrada (senha: ${novo.senha})`);
    await onRecarregar();
  }
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "Painel da Professora"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 10.5,
      color: C.cinza,
      letterSpacing: ".2em",
  ...
  }, "Resifriends · Turma Premium"))), /*#__PURE__*/React.createElement("button", {
    onClick: onSair,
    style: {
  ...
  }, [["visao", "Visão da turma"], ["alunos", "Gerenciar alunos"]].map(([k, v]) => /*#__PURE__*/React.createElement("button", {
    key: k,
    onClick: () => setAba(k),
    style: {
      background: "none",
      ...
      fontSize: 14,
      fontWeight: 700,
      color: aba === k ? C.douradoClaro : C.cinza,
      borderBottom: aba === k ? `2px solid ${C.dourado}` : "2px solid transparent",
      fontFamily: "Lato, sans-serif"
    }
  ...
  }, aba === "visao" && /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    style: {
      display: "grid",
  ...
  }, [["Alunos ativos", alunos.length, "de 12 vagas"], ["Questões resolvidas", ranking.reduce((s, a) => s + a.feitas, 0), "pela turma toda"], ["Média da turma", ranking.length ? Math.round(ranking.reduce((s, a) => s + a.pct, 0) / ranking.length) + "%" : "—", "de aproveitamento"], ["Horas nesta semana", ranking.reduce((s, a) => s + a.hSemana, 0).toFixed(1).replace(".0", "") + "h", "declaradas pela turma"], ["Sumiram (5+ dias)", ranking.filter(a => a.inativoHa !== null && a.inativoHa >= 5).length + ranking.filter(a => a.inativoHa === null).length, "precisam de contato"]].map(([t, v, s]) => /*#__PURE__*/React.createElement("div", {
    key: t,
    style: card
  }, /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, "Ranking e acompanhamento"), /*#__PURE__*/React.createElement("p", {
    style: {
      color: C.cinza,
      fontSize: 13.5,
      margin: "0 0 18px"
    }
  }, "Cada aluno, com nome e desempenho em tempo real. Use isto para direcionar suas aulas."), ranking.length === 0 ? /*#__PURE__*/React.createElement("div", {
    style: {
      ...card,
      textAlign: "center",
      color: C.cinza
    }
  }, "Nenhum aluno cadastrado ainda. Vá em ", /*#__PURE__*/React.createElement("b", {
    style: {
      color: C.dourado
    }
  }, "Gerenciar alunos"), " para começar.") : /*#__PURE__*/React.createElement("div", {
    style: {
      display: "grid",
      gap: 10
    }
  }, ranking.map((a, i) => /*#__PURE__*/React.createElement("div", {
    key: a.codigo,
    style: {
      ...card,
      padding: 15,
    ...
    style: {
      ...
      fontSize: 19,
      fontWeight: 800,
      color: i === 0 ? C.dourado : C.cinza
    }
  }, i + 1, "º"), /*#__PURE__*/React.createElement("div", {
    style: {
      width: 40,
      height: 40,
      borderRadius: "50%",
      background: `linear-gradient(135deg, ${C.dourado}, ${C.marrom})`,
      display: "flex",
      alignItems: "center",
      justifyContent: "center",
      fontWeight: 800,
  ...
  }, a.nome.split(" ").map(n => n[0]).slice(0, 2).join("")), /*#__PURE__*/React.createElement("div", {
    style: {
      flex: "1 1 200px"
    }
  }, /*#__PURE__*/React.createElement("div", {
  ...
  }, a.nome), a.inativoHa !== null && a.inativoHa >= 5 && /*#__PURE__*/React.createElement("span", {
    style: {
  ...
  }, "sumiu"), a.seq >= 5 && /*#__PURE__*/React.createElement("span", {
    style: {
      background: C.verde,
      color: "#fff",
      fontSize: 9,
  ...
  }, "🔥 ", a.seq, " dias")), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 11.5,
      color: C.cinza,
      marginTop: 2
    }
  }, a.codigo, " · ", a.feitas, " questões · ", a.aulas, "/", totalAulas, " aulas"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 11.5,
      marginTop: 3,
      display: "flex",
    ...
    style: {
      color: a.inativoHa === null ? C.cinza : a.inativoHa >= 5 ? "#f0a09c" : a.inativoHa <= 1 ? "#7fe0a6" : C.cinza
    }
  }, "Ativa ", rotuloUltimaAtiv(a.ultima)), /*#__PURE__*/React.createElement("span", {
    style: {
      color: C.douradoClaro
    }
  }, a.hSemana ? `${a.hSemana.toFixed(1).replace(".0", "")}h esta semana` : "sem horas registradas"))), /*#__PURE__*/React.createElement("div", {
    style: {
      textAlign: "right"
    }
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      ...
      fontWeight: 800,
      fontSize: 20,
      color: a.pct >= 80 ? C.verde : a.pct >= 65 ? C.dourado : a.feitas ? C.vermelho : C.cinza
    }
  }, a.feitas ? a.pct + "%" : "—"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 10.5,
      color: C.cinza
    }
  }, a.feitas ? `${a.acertos} acertos` : "sem atividade")))))), aba === "alunos" && /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    style: {
      ...card,
      marginBottom: 22
    }
  ...
  }, "Cadastrar novo aluno"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "grid",
  ...
  }, "Nome da aluna"), /*#__PURE__*/React.createElement("input", {
    style: inputStyle,
  ...
  }, "Código de acesso"), /*#__PURE__*/React.createElement("input", {
    style: {
      ...inputStyle,
      textTransform: "uppercase"
    },
  ...
  }, "Senha da aluna"), /*#__PURE__*/React.createElement("input", {
    style: inputStyle,
    placeholder: "Ex.: Maria1234",
    value: senhaNova,
    onChange: e => setSenhaNova(e.target.value)
  })), /*#__PURE__*/React.createElement("button", {
    style: btnOuro,
    onClick: cadastrar
  }, "+ Cadastrar")), msg && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 14,
      padding: "10px 12px",
      background: msg.startsWith("✓") ? "#12321f" : "#321413",
      border: `1px solid ${msg.startsWith("✓") ? C.verde : C.vermelho}`,
      borderRadius: 8,
      color: msg.startsWith("✓") ? "#7fe0a6" : "#f0a09c",
      fontSize: 13
    }
  ...
  }, "A aluna entra escolhendo o nome na lista e digitando a senha. Turma: ", alunos.length, "/12 (teto 15).")), /*#__PURE__*/React.createElement("h3", {
    style: {
      fontFamily: "Playfair Display, serif",
      fontSize: 17,
      fontWeight: 700,
  ...
  }, "Alunos cadastrados"), alunos.length === 0 ? /*#__PURE__*/React.createElement("div", {
    style: {
      ...card,
      textAlign: "center",
      color: C.cinza
    }
  }, "Nenhum aluno ainda. Cadastre o primeiro acima.") : /*#__PURE__*/React.createElement("div", {
    style: {
      display: "grid",
      gap: 10
    }
  }, alunos.map(a => /*#__PURE__*/React.createElement("div", {
    key: a.codigo,
    style: {
      ...card,
      padding: 14,
  ...
  }, a.nome.split(" ").map(n => n[0]).slice(0, 2).join("")), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    style: {
      fontWeight: 700,
      fontSize: 14.5
    }
  ...
  }, a.senha || "—")))), /*#__PURE__*/React.createElement("button", {
    onClick: () => remover(a.codigo),
    style: {
      background: "transparent",
      border: `1px solid ${C.vermelho}`,
      color: "#f0a09c",
...
function PortalAluno({
  ...
  function proxima() {
    setEscolha(null);
    setQIdx(i => (i + 1) % bancoFiltrado.length);
  }
  async function registrarHoras(dia, horas) {
    ...
    if (!h || h <= 0) delete novoDiario[dia];else novoDiario[dia] = Math.min(h, 24);
    await salvar({
      ...prog,
      diario: novoDiario
    });
  ...
  function statsEixo(eixoId) {
    ...
    return {
      ...
      pct: feitas.length ? Math.round(acertos.length / feitas.length * 100) : 0,
      aulasE,
      feitasAulas
    };
  }
  const abaBtn = a => ({
    ...
    fontSize: 14,
    fontWeight: 700,
    color: aba === a ? C.douradoClaro : C.cinza,
    borderBottom: aba === a ? `2px solid ${C.dourado}` : "2px solid transparent",
    fontFamily: "Lato, sans-serif"
  });
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "Olá, ", primeiroNome), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 11,
      color: C.cinza
    }
  }, "Turma Premium · 2026")), /*#__PURE__*/React.createElement("div", {
    style: {
      width: 40,
      height: 40,
      borderRadius: "50%",
  ...
  }, iniciais), /*#__PURE__*/React.createElement("button", {
    onClick: onSair,
    style: {
      background: "transparent",
      color: C.cinza,
  ...
  }, [["inicio", "Início"], ["aulas", "Aulas Gravadas"], ["modulos", "Módulos"], ["biblioteca", "Biblioteca"], ["questoes", "Questões"], ["discursivas", "Discursivas"], ["diario", "Meu Diário"], ["desempenho", "Desempenho"]].map(([k, v]) => /*#__PURE__*/React.createElement("button", {
    key: k,
    style: abaBtn(k),
    onClick: () => setAba(k)
  }, v)))), /*#__PURE__*/React.createElement("main", {
  ...
  }, aba === "inicio" && /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    style: {
      textAlign: "center",
      padding: "18px 0 30px"
    }
  ...
  }, "Preparado exclusivamente para você,"), /*#__PURE__*/React.createElement("h1", {
    style: {
      fontFamily: "Playfair Display, serif",
  ...
  }, aluno.nome), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      alignItems: "center",
      justifyContent: "center",
    ...
    style: {
      width: 44,
      height: 1,
      background: `linear-gradient(90deg, transparent, ${C.dourado})`
    }
  }), /*#__PURE__*/React.createElement("div", {
    style: {
      width: 5,
    ...
    style: {
      width: 44,
      height: 1,
      background: `linear-gradient(90deg, ${C.dourado}, transparent)`
    }
  }))), /*#__PURE__*/React.createElement("div", {
    style: {
      ...card,
      background: `linear-gradient(120deg, ${C.preto2} 60%, ${C.marrom}55)`,
      display: "flex",
      alignItems: "center",
      justifyContent: "space-between",
      flexWrap: "wrap",
  ...
  }, "Sua jornada"), /*#__PURE__*/React.createElement("h2", {
    style: {
      fontFamily: "Playfair Display, serif",
      fontSize: 27,
      fontWeight: 800,
  ...
  }, aulasFeitas === 0 ? /*#__PURE__*/React.createElement(React.Fragment, null, "Bem-vinda, ", primeiroNome, ". ", /*#__PURE__*/React.createElement("span", {
    style: {
      color: C.douradoClaro
    }
  }, "Vamos começar?")) : /*#__PURE__*/React.createElement(React.Fragment, null, "Você já venceu ", /*#__PURE__*/React.createElement("span", {
    style: {
      color: C.douradoClaro
    }
  }, pctAulas, "%"), " do caminho")), /*#__PURE__*/React.createElement("p", {
    style: {
      color: "#cfc7bd",
      fontSize: 14.5,
      lineHeight: 1.55,
  ...
  }, aulasFeitas === 0 ? "Sua preparação começa agora. Comece pelos módulos de peso alto e resolva suas primeiras questões." : "Continue firme. Cada aula e cada questão te aproximam da aprovação.")), /*#__PURE__*/React.createElement(Ring, {
    pct: pctAulas,
    label: `${pctAulas}%`,
    sub: "Concluído"
  })), /*#__PURE__*/React.createElement("div", {
  ...
  }, [["Aproveitamento", totFeitas ? `${pctGeral}%` : "—", totFeitas ? `${totAcertos} de ${totFeitas}` : "resolva questões"], ["Aulas", `${aulasFeitas}/${totalAulas}`, "concluídas"], ["Questões", totFeitas, "resolvidas"]].map(([t, v, s]) => /*#__PURE__*/React.createElement("div", {
    key: t,
    style: card
  }, /*#__PURE__*/React.createElement("div", {
    style: {
    ...
    style: {
      ...card,
      background: `linear-gradient(135deg, ${C.cardBg}, ${C.preto2})`,
      position: "relative",
      padding: "28px 30px",
      marginBottom: 22
    }
  ...
  }, primeiroNome, ", eu escolhi trabalhar com pouquíssimos alunos por um motivo: quero acompanhar cada passo da sua caminhada. Aqui você não é um número. Você é a próxima aprovação."), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      alignItems: "center",
      gap: 10,
  ...
  }, "Profa. Fátima Barbosa"))), aulasFeitas < 3 && /*#__PURE__*/React.createElement("a", {
    href: "Resifriends_Manual_do_Aluno.pdf",
    target: "_blank",
    rel: "noreferrer",
    style: {
      ...card,
      ...
      marginBottom: 22,
      textDecoration: "none",
      border: `1px solid ${C.dourado}66`,
      transition: "all .2s"
    },
    onMouseEnter: e => {
      e.currentTarget.style.borderColor = C.dourado;
    },
    onMouseLeave: e => {
      e.currentTarget.style.borderColor = `${C.dourado}66`;
    }
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      width: 38,
  ...
  }, "Comece por aqui"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontFamily: "Playfair Display, serif",
      fontSize: 17,
      fontWeight: 700,
  ...
  }, "Manual do Aluno"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 12,
      color: C.cinza,
      marginTop: 2
    }
  }, "Como o curso funciona, o método e sua rotina · 24 páginas")), /*#__PURE__*/React.createElement("span", {
    style: {
      color: C.douradoClaro,
      fontSize: 13,
      flexShrink: 0
  ...
  }, "Sugestão de hoje"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontFamily: "Playfair Display, serif",
      fontSize: 18,
      fontWeight: 700
    }
  }, "Resolva 5 questões dos eixos de peso alto"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 12.5,
      color: C.cinza,
      marginTop: 3
    }
  }, "É o hábito que mais aproxima da aprovação")), /*#__PURE__*/React.createElement("button", {
    onClick: () => setAba("questoes"),
    style: btnOuro
  }, "Ir para questões →"))), aba === "aulas" && /*#__PURE__*/React.createElement(AulasGravadas, {
    nomeAluno: aluno.nome
  }), aba === "biblioteca" && /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h2", {
    style: {
      fontFamily: "Playfair Display, serif",
      fontSize: 24,
      fontWeight: 800,
  ...
  }, "Biblioteca de Estudo"), /*#__PURE__*/React.createElement("p", {
    style: {
      color: C.cinza,
      fontSize: 13.5,
      margin: "0 0 6px"
    }
  }, "Material autoral da turma, conferido nas fontes oficiais. Cada e-book traz teoria, o raciocínio clínico por trás dela, os bizus e as pegadinhas da banca."), /*#__PURE__*/React.createElement("p", {
    style: {
      color: C.douradoClaro,
      fontSize: 12.5,
      margin: "0 0 22px"
    ...
    const t = EIXOS.flatMap(e => e.ebooks || []);
    return `${t.length} e-books · ${t.reduce((a, b) => a + b.pag, 0)} páginas`;
  })()), /*#__PURE__*/React.createElement("div", {
    style: {
      ...card,
      border: `1px solid ${C.dourado}66`,
  ...
  }, "Material do curso"), /*#__PURE__*/React.createElement("span", {
    style: {
      background: C.dourado,
      color: C.preto,
      fontSize: 9.5,
  ...
  }, "Leia primeiro")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "grid",
      gap: 8
    }
  }, MATERIAL_CURSO.map(m => /*#__PURE__*/React.createElement("a", {
    key: m.arq,
    href: m.arq,
    target: "_blank",
    rel: "noreferrer",
    ...
    onMouseEnter: ev => {
      ev.currentTarget.style.borderColor = C.dourado;
    },
    onMouseLeave: ev => {
      ev.currentTarget.style.borderColor = C.marrom;
    }
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      width: 34,
  ...
  }, m.pag, " páginas · PDF · abrir ↗")))))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "grid",
      gap: 16
    }
  }, EIXOS.filter(e => e.ebooks && e.ebooks.length).map(e => /*#__PURE__*/React.createElement("div", {
    key: e.id,
    style: {
      ...card,
      border: e.bonus ? `1px solid ${C.dourado}66` : card.border
    }
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
  ...
  }, e.nome), pesoTag(e.peso)), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "grid",
      gap: 8
    }
  }, e.ebooks.map(eb => /*#__PURE__*/React.createElement("a", {
    key: eb.arq,
    href: eb.arq,
    target: "_blank",
    rel: "noreferrer",
  ...
  }, eb.titulo), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 11.5,
      color: C.cinza,
      lineHeight: 1.45,
  ...
  }, eb.desc), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 10.5,
      color: C.douradoClaro,
      marginTop: 4,
  ...
  }, eb.pag, " páginas · PDF · abrir ↗")))))))), /*#__PURE__*/React.createElement("div", {
    style: {
      ...card,
      marginTop: 18,
      background: `linear-gradient(135deg, ${C.cardBg}, ${C.preto2})`
  ...
  }, "Como usar"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 13,
      color: "#cfc7bd",
      lineHeight: 1.55
    }
  }, "Leia o e-book ", /*#__PURE__*/React.createElement("strong", {
    style: {
      color: C.creme
    }
  }, "antes"), " da aula ao vivo. Na aula, a gente aprofunda e ataca as questões. Depois, volte à síntese final do e-book — ela foi feita para ser sua revisão de véspera."))), aba === "modulos" && /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h2", {
    style: {
      fontFamily: "Playfair Display, serif",
      fontSize: 24,
      fontWeight: 800,
  ...
  }, "Seus módulos"), /*#__PURE__*/React.createElement("p", {
    style: {
      color: C.cinza,
      fontSize: 13.5,
      margin: "0 0 22px"
    }
  }, "Organizados por peso na prova. Comece pelos de peso alto."), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "grid",
      gap: 14
    }
    ...
    return /*#__PURE__*/React.createElement("div", {
    ...
    }, e.nome), pesoTag(e.peso), /*#__PURE__*/React.createElement("span", {
      style: {
        marginLeft: "auto",
        fontSize: 12,
        color: C.cinza
      }
    }, e.bonus ? "questões comentadas" : `${st.feitasAulas}/${e.aulas} aulas`)), e.subs && /*#__PURE__*/React.createElement("div", {
      style: {
        display: "flex",
        gap: 6,
        flexWrap: "wrap",
    ...
    }, e.subs.map(s => /*#__PURE__*/React.createElement("span", {
      key: s,
      style: {
        fontSize: 11.5,
        color: C.cinza,
    ...
    }, s))), e.ebooks && e.ebooks.length > 0 && /*#__PURE__*/React.createElement("div", {
      style: {
        marginBottom: 14
      }
    }, /*#__PURE__*/React.createElement("div", {
    ...
    }, e.ebooks.length === 1 ? "E-book deste módulo" : `E-books deste módulo (${e.ebooks.length})`), /*#__PURE__*/React.createElement("div", {
      style: {
        display: "grid",
        gap: 8
      }
    ...
    }, eb.pag, " páginas · PDF · abrir ↗")))))), e.bonus ? /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 12.5,
        color: C.douradoClaro,
        lineHeight: 1.5
      }
    }, "Conteúdo bônus da turma: sem aula ao vivo, mas com questões comentadas para você não deixar nada de fora.") : /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
      style: {
        height: 8,
        background: "#5a3d26",
        borderRadius: 5,
      ...
      style: {
        width: `${pct}%`,
        height: "100%",
        background: `linear-gradient(90deg, ${C.dourado}, ${C.douradoClaro})`,
      ...
      return /*#__PURE__*/React.createElement("button", {
        key: n,
        onClick: () => marcarAula(e.id, n),
        title: feita ? "Aula concluída" : "Marcar como assistida",
        style: {
          width: 34,
          height: 34,
          borderRadius: 8,
          border: `1px solid ${feita ? C.verde : "#5a3d26"}`,
          background: feita ? "#153d2a" : "#3A2517",
          color: feita ? "#7fe0a6" : C.cinza,
          cursor: "pointer",
          fontSize: 12,
          fontWeight: 700,
          fontFamily: "Lato, sans-serif"
  ...
  }))), aba === "questoes" && qAtual && /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      alignItems: "center",
      justifyContent: "space-between",
  ...
  }, "Banco de Questões"), /*#__PURE__*/React.createElement("p", {
    style: {
      color: C.cinza,
      fontSize: 13.5,
      margin: 0
    }
  }, "Responda e veja o comentário na hora. Seu progresso é salvo automaticamente.")), /*#__PURE__*/React.createElement("div", {
    style: {
      textAlign: "right",
      fontSize: 12.5,
      color: C.cinza
    }
  }, /*#__PURE__*/React.createElement("div", null, "Resolvidas: ", /*#__PURE__*/React.createElement("b", {
    style: {
      color: C.creme
    }
  }, totFeitas)), /*#__PURE__*/React.createElement("div", null, "Acertos: ", /*#__PURE__*/React.createElement("b", {
    style: {
      color: C.verde
    }
  }, totAcertos), " · Erros: ", /*#__PURE__*/React.createElement("b", {
    style: {
      color: C.vermelho
    }
  }, totFeitas - totAcertos)))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 8,
      flexWrap: "wrap",
  ...
  }, [["todos", "Todos"], ...EIXOS.map(e => [e.id, e.curto || e.nome])].map(([k, v]) => /*#__PURE__*/React.createElement("button", {
    key: k,
    onClick: () => {
      setFiltroEixo(k);
      setQIdx(0);
    ...
    style: {
      background: filtroEixo === k ? C.dourado : "transparent",
      color: filtroEixo === k ? C.preto : C.cinza,
      border: `1px solid ${filtroEixo === k ? C.dourado : "#5a3d26"}`,
      borderRadius: 20,
      padding: "6px 14px",
      fontSize: 12.5,
      fontWeight: 700,
  ...
  }, qAtual.sub || qAtual.tema), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 12,
      color: C.cinza
    }
  }, "Questão ", qIdx + 1, " de ", bancoFiltrado.length)), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 16.5,
      lineHeight: 1.5,
      fontWeight: 700,
  ...
  }, qAtual.enunciado), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "grid",
      gap: 10
    }
    ...
    return /*#__PURE__*/React.createElement("button", {
      ...
      style: {
        fontFamily: "Playfair Display, serif",
        fontWeight: 800,
        color: jaResp && i === qAtual.correta ? C.verde : C.dourado
      }
    }, letra), /*#__PURE__*/React.createElement("span", null, a));
  })), jaResp && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 18,
      padding: "15px 16px",
      background: prog.respostas[qAtual.id] ? "#12321f" : "#321413",
      border: `1px solid ${prog.respostas[qAtual.id] ? C.verde : C.vermelho}`,
      borderRadius: 10
    }
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      ...
      fontSize: 13.5,
      marginBottom: 6,
      color: prog.respostas[qAtual.id] ? "#7fe0a6" : "#f0a09c",
      letterSpacing: ".04em",
      textTransform: "uppercase"
    }
  }, prog.respostas[qAtual.id] ? "✓ Você acertou!" : "✗ Resposta incorreta"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 13.5,
      lineHeight: 1.55,
      color: "#e8e0d6"
  ...
  }, "Comentário:"), " ", qAtual.coment)), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
    ...
    style: {
      ...btnOuro,
      background: jaResp ? btnOuro.background : "#5a3d26",
      color: jaResp ? C.preto : C.cinza,
      cursor: jaResp ? "pointer" : "default"
    }
  }, "Próxima questão →")))), aba === "discursivas" && (() => {
    ...
    return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h2", {
    ...
    }, "Questões Discursivas"), /*#__PURE__*/React.createElement("p", {
      style: {
        color: C.cinza,
        fontSize: 13.5,
        margin: "0 0 6px",
    ...
    }, "Aqui não se marca alternativa — ", /*#__PURE__*/React.createElement("strong", {
      style: {
        color: C.creme
      }
    }, "se explica o porquê"), ". É o raciocínio clínico que sustenta o acerto na objetiva."), /*#__PURE__*/React.createElement("p", {
      style: {
        color: C.douradoClaro,
        fontSize: 12.5,
        margin: "0 0 22px"
      }
    }, "Escreva sua resposta ANTES de abrir o espelho. Sem isso, o exercício não funciona."), /*#__PURE__*/React.createElement("div", {
      style: {
        display: "flex",
        justifyContent: "space-between",
        alignItems: "center",
    ...
    }, d.tempoEstimado, " · cerca de ", d.linhas, " linhas")), /*#__PURE__*/React.createElement("span", {
      style: {
        fontSize: 12,
        color: C.cinza
      }
    }, "Discursiva ", dIdx + 1, " de ", DISCURSIVAS.length)), /*#__PURE__*/React.createElement("div", {
      style: {
        ...card,
        marginBottom: 16
      }
    ...
    }, d.enunciado)), /*#__PURE__*/React.createElement("div", {
      style: {
        ...card,
        marginBottom: 16
      }
    ...
    }, "Sua resposta"), /*#__PURE__*/React.createElement("textarea", {
      value: dRascunho,
      onChange: e => setDRascunho(e.target.value),
    ...
    }, dRascunho.trim() ? dRascunho.trim().split(/\s+/).length + " palavras" : "rascunho nao e salvo - copie se quiser guardar")), !dRevelar ? /*#__PURE__*/React.createElement("div", {
      style: {
        textAlign: "center",
        marginBottom: 16
      }
    }, /*#__PURE__*/React.createElement("button", {
      onClick: () => setDRevelar(true),
      style: btnOuro
    }, "Abrir roteiro e espelho"), /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 11.5,
        color: C.cinza,
        marginTop: 10
      }
    }, "Escreveu? Entao pode abrir.")) : /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
      style: {
        ...card,
        marginBottom: 16,
        border: "1px solid " + C.marrom
    ...
    }, "Roteiro - o que sua resposta precisa conter"), /*#__PURE__*/React.createElement("div", {
      style: {
        display: "grid",
        gap: 7
      }
    }, d.roteiro.map((r, i) => /*#__PURE__*/React.createElement("div", {
      key: i,
      style: {
        display: "flex",
        gap: 9,
    ...
    }, "Espelho comentado"), /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 14,
        lineHeight: 1.7,
        color: "#e8e0d6",
    ...
    }, d.espelho)), /*#__PURE__*/React.createElement("div", {
      style: {
        ...card,
        marginBottom: 16,
        border: "1px solid " + C.vermelho + "66",
        background: "#241a19"
      }
    }, /*#__PURE__*/React.createElement("div", {
      style: {
    ...
    }, "Como a banca arma a pegadinha"), /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 14,
        lineHeight: 1.7,
        color: "#e8e0d6",
    ...
    }, d.pegadinha))), /*#__PURE__*/React.createElement("div", {
      style: {
        display: "flex",
        justifyContent: "space-between",
        gap: 10
      ...
      onClick: () => {
        setDIdx(i => (i - 1 + DISCURSIVAS.length) % DISCURSIVAS.length);
        setDRevelar(false);
        setDRascunho("");
      },
      style: {
      ...
      onClick: () => {
        setDIdx(i => (i + 1) % DISCURSIVAS.length);
        setDRevelar(false);
        setDRascunho("");
      },
      style: btnOuro
    }, "Proxima discursiva")));
  })(), aba === "diario" && /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h2", {
    style: {
      fontFamily: "Playfair Display, serif",
      fontSize: 24,
      fontWeight: 800,
  ...
  }, "Meu Diário de Estudo"), /*#__PURE__*/React.createElement("p", {
    style: {
      color: C.cinza,
      fontSize: 13.5,
      margin: "0 0 6px",
  ...
  }, "Registre quantas horas você estudou por dia — ", /*#__PURE__*/React.createElement("strong", {
    style: {
      color: C.creme
    }
  }, "tudo conta"), ": e-book, caderno, questões, aula, revisão."), /*#__PURE__*/React.createElement("p", {
    style: {
      color: C.douradoClaro,
      fontSize: 12.5,
      margin: "0 0 22px"
    }
  }, "Este registro é seu. Serve para você enxergar sua constância — e para eu te ajudar melhor na mentoria."), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "grid",
      gridTemplateColumns: "repeat(auto-fit, minmax(150px, 1fr))",
      gap: 14,
  ...
  }, [["Esta semana", `${horasPeriodo(prog.diario, 7).toFixed(1).replace(".0", "")}h`, "registradas"], ["Últimos 30 dias", `${horasPeriodo(prog.diario, 30).toFixed(1).replace(".0", "")}h`, "no total"], ["Sequência", `${sequencia(prog.atividade)} ${sequencia(prog.atividade) === 1 ? "dia" : "dias"}`, "sem falhar"]].map(([t, v, sub]) => /*#__PURE__*/React.createElement("div", {
    key: t,
    style: card
  }, /*#__PURE__*/React.createElement("div", {
    style: {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      style: {
        ...
        alignItems: "center",
        gap: 12,
        background: eHoje ? "#241f17" : "#3A2517",
        border: `1px solid ${eHoje ? C.dourado : "#5a3d26"}`,
        borderRadius: 8,
        padding: "10px 14px"
      }
    }, /*#__PURE__*/React.createElement("div", {
      ...
      style: {
        fontSize: 12.5,
        fontWeight: 700,
        color: eHoje ? C.douradoClaro : C.creme
      }
    }, diaSemana(dia), eHoje ? " · hoje" : ""), /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 11,
        color: C.cinza
      }
    }, d, "/", m)), /*#__PURE__*/React.createElement("input", {
      type: "number",
      min: "0",
      max: "24",
      step: "0.5",
      ...
      style: {
        width: 74,
        background: "#191715",
        border: `1px solid ${h ? C.marrom : "#5a3d26"}`,
        borderRadius: 6,
        padding: "8px 10px",
        color: C.creme,
        fontSize: 14,
      ...
      style: {
        width: `${Math.min((Number(h) || 0) / 6 * 100, 100)}%`,
        height: "100%",
        background: `linear-gradient(90deg, ${C.marrom}, ${C.douradoClaro})`,
  ...
  }, "Registre com sinceridade — inclusive os dias de zero. O valor deste diário está em mostrar a verdade, não o ideal.")), /*#__PURE__*/React.createElement("div", {
    style: {
      ...card,
      marginTop: 18,
      background: `linear-gradient(135deg, ${C.cardBg}, ${C.preto2})`
  ...
  }, "Por que registrar"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 13,
      color: "#cfc7bd",
      lineHeight: 1.55
    }
  }, "Quem mede, enxerga. Quem enxerga, ajusta. Não existe número certo de horas — existe ", /*#__PURE__*/React.createElement("strong", {
    style: {
      color: C.creme
    }
  }, "constância"), ". Uma hora todo dia vence seis horas só no domingo."))), aba === "desempenho" && /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h2", {
    style: {
      fontFamily: "Playfair Display, serif",
      fontSize: 24,
      fontWeight: 800,
  ...
  }, "Meu desempenho"), /*#__PURE__*/React.createElement("p", {
    style: {
      color: C.cinza,
      fontSize: 13.5,
      margin: "0 0 22px"
    }
  }, "Seu aproveitamento por eixo. Priorize os de menor acerto e maior peso."), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 20,
      flexWrap: "wrap",
  ...
  }, totFeitas ? "Aproveitamento geral" : "Resolva questões para ver")), /*#__PURE__*/React.createElement("div", {
    style: {
      flex: "2 1 400px",
      display: "grid",
      gap: 12
    ...
    }, st.qFeitas ? st.pct + "%" : "—")), /*#__PURE__*/React.createElement("div", {
      style: {
        height: 8,
        background: "#5a3d26",
        borderRadius: 5,
    ...
    }, st.qFeitas, "/", st.qTotal, " questões respondidas · ", pesoLabel(e.peso)));
  }))))), /*#__PURE__*/React.createElement("footer", {
    style: {
      borderTop: "1px solid #5a3d26",
      padding: "18px 0",
      textAlign: "center"
    }
  }, /*#__PURE__*/React.createElement("div", {
  ...
  }, "Planeje. Estude. Execute. Alcance."), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 10.5,
      color: C.cinza,
      letterSpacing: ".1em",
  ...
  }, "RESIFRIENDS · Profa. Fátima Barbosa")));
}
function AulasGravadas({
  nomeAluno
}) {
  ...
  }, "Aulas Gravadas"), /*#__PURE__*/React.createElement("p", {
    style: {
      color: C.cinza,
      fontSize: 13.5,
      margin: "0 0 20px"
    }
  }, "Reveja as aulas quando quiser. Conteúdo exclusivo da turma — não compartilhe."), aulaAtiva ? /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("button", {
  ...
  }, "← Voltar às aulas"), /*#__PURE__*/React.createElement("div", {
    style: {
      ...card,
      padding: 0,
      overflow: "hidden"
  ...
  }, nomeAluno, " · Resifriends"), /*#__PURE__*/React.createElement("div", {
    style: {
      position: "absolute",
      bottom: "22%",
      left: "8%",
  ...
  }, nomeAluno)), /*#__PURE__*/React.createElement("div", {
    style: {
      padding: 18
    }
  }, /*#__PURE__*/React.createElement("div", {
  ...
  }, aulaAtiva.eixo), /*#__PURE__*/React.createElement("div", {
    style: {
      fontFamily: "Playfair Display, serif",
      fontSize: 19,
      fontWeight: 700
    }
  }, aulaAtiva.titulo), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 12.5,
      color: C.cinza,
      marginTop: 4
    }
  }, aulaAtiva.dur, " · aula de ", aulaAtiva.data))), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 14,
      padding: "12px 15px",
      background: "#3A2517",
  ...
  }, "🔒 Este vídeo é exclusivo da turma e está identificado com o seu nome. O compartilhamento é rastreável e proibido.")) : /*#__PURE__*/React.createElement("div", {
    style: {
      display: "grid",
      gap: 12
    }
  }, AULAS_GRAVADAS.map(a => /*#__PURE__*/React.createElement("div", {
    key: a.id,
    onClick: () => setAulaAtiva(a),
    style: {
      ...card,
      padding: 15,
      display: "flex",
  ...
  }, a.eixo), /*#__PURE__*/React.createElement("div", {
    style: {
      fontFamily: "Playfair Display, serif",
      fontSize: 16,
      fontWeight: 700
